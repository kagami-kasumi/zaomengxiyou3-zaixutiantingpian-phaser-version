...
| 功能 UI 真值债务 | 175A..I 已全部生成 verified 真值；宠物页、法宝页、功能宿主和技能四页已分别直接消费 74/16、28/21、25/42、250/32 对象/状态真值并删除现代覆盖/手写视觉源 | 丹药/商城/设置/任务/建档 view 尚未直连 manifest；TASK-SLICE-184..187 待逐页实现 | 175 审计、175A..I manifests；180..183 运行投影、差异证据与专项 |
...
34. `TASK-SLICE-184`：Ready；直接消费 175F 商城页真值，删除商城页手写视觉源并完成逐状态业务/owner/存档回归。185..187 保持同线 Planned。
