...
| 功能 UI 真值债务 | 175A..I 已全部生成 verified 真值；宠物页、法宝页、功能宿主、技能四页和商城页已分别直接消费 74/16、28/21、25/42、250/32、132/31 对象/状态真值并删除现代覆盖/手写视觉源 | 丹药/设置/任务/建档 view 尚未直连 manifest；TASK-SLICE-185..187 待逐页实现 | 175 审计、175A..I manifests；180..184 运行投影、差异证据与专项 |
...
35. `TASK-SLICE-185`：Ready；直接消费 175G 设置页真值，删除设置页手写视觉源并完成 23 状态 owner/持久化回归。186..187 保持同线 Planned。
