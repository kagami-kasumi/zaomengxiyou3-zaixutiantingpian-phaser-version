...
既有主循环、资源分包和技能视觉闭环继续作为回归基线；本线当前因 `PG-010` 保持重开。`GOAL-035 / TASK-ARCH-013A` 已闭合玩家直属灵魂、V6 与 V1..V5 无损迁移；当前由 `GOAL-036 / TASK-ARCH-013B` 闭合统一消费合同、全部已知消费者与正式旅程，完成前不恢复 `LINE-STAGE-2-3`。
