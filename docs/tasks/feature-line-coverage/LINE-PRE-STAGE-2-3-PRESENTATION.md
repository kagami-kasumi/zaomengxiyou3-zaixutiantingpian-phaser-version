...
| 宠物战斗公共类 | 203/204A 建立旧骨架；205 闭合 35 形态基类证据；206 冻结组合设计；204B 让结构 P1/P1B gate=0；207/208A 让猴系语义 P1R=0；209/210 让马系 43 项合同与正式 P1H=0；224A玄龟17项/P1TA及224B的SYBH/奥义/受伤结算13项/P1TB通过；全32联合仍待C | 青龙44合同/P1G已闭合；猴马旧时序实现受反证，224C后由226重做；其余六家族与最终兼容入口仍未闭合 | 后续继续按完整证据→独立语义 verifier→正式运行合同逐族推进，最终 all=0 |
| 宠物真动画 | 193 已冻结 35 形态/38 技能映射；193A..193D 已闭合猴/马视觉真值与投影；208A/210 已把两族动作/effect 绑定到 CombatRuntime action/projectile token；224A接原生本体clock、普攻/SLD相位与双owner链接显示；224B接SYBH/奥义递归相位及hurt/dead | 青龙语义/真动画同链已闭合；猴马资源证据保留但行为决策相位待226修正；其余六家族仍待 | 逐族闭合后由 194 最终跨族校准 |
...
30. `TASK-SLICE-196`：五角色统一动作流畅度、UI 完整度和正式 Runtime 校准；不代替单角色修复。
31. `TASK-SETTINGS-197 -> TASK-SLICE-198 -> TASK-SLICE-199`：技能功能页保持独立已有证据；本批只闭合战斗技能 HUD 真值、可见投影和运行联动。
32. `TASK-SLICE-200`：集中正式旅程与整线关闭；通过后才恢复 `LINE-STAGE-2-3 / TASK-SETTINGS-064`。
