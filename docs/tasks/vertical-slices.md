...
| VS-064 完整背包资源基础闭环 | 已完成 | 原版 1.1 可入包资源全集使用统一身份、真图标、四分类、堆叠/实例、容量、P1/P2 owner 与 V6 往返，并能被丹药/商城/任务/掉落/工坊复用 | M-035、M-036、M-037、M-044、M-052 | `GOAL-049/050` 闭合 431 项权威目录、428 真图标、统一事务、双 owner 与 V6；166A..D 闭合正式背包；165D 闭合炼丹炉第二消费者与 verified 真值；168A 证明强化/合成动态槽继续复用同一真图标投影 | 3 项原版图标缺陷排除；正式背包与炼丹炉均消费同一只读 cell/grid/icon/quantity 投影，25 格/四分类/五页、双 owner、战斗即时/地图回退、工坊暂存/返还和 940×590 已通过 |
