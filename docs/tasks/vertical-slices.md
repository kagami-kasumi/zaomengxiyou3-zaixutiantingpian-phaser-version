...
| VS-060 关卡内五功能入口闭环 | 进行中 | 设置、技能、背包、法宝、宠物在正式关卡内按原版状态可点击并正确暂停/返回 | M-016、M-035、M-043、M-052 | `TASK-SLICE-156A/B` 已闭合 574/371/444、共享 router、全局设置 owner 与原版单页会话语义；仅 `156C` 待完成 | 当前在五关做 P1/P2、门禁、暂停、同键、Escape 和返回逐状态校准；战斗现代可见跨页 host 已移除 |
