...
| VS-067 宠物真 UI 与真动画闭环 | 部分实现 | 正式 P1/P2 宠物页/战斗 UI 可见，动态头像由逐状态递归真值投影，所有已支持物种/形态的适用本体与技能动作使用恢复源真时间轴 | M-016、M-034、M-035、M-042、M-049、M-052 | `TASK-SETTINGS-191/193/193A/193C/201/205/207/209`、`TASK-SLICE-192A/192B/193B/193D/194/202/208/208A`、`TASK-ARCH-203/204A/204B/206` | 208A 已让猴系四形态 × P1/P2 `attackRange` 外追击→入围攻击→verified hit→pet-source damage/cleanup 的语义 P1R=0，并修订 Skill；当前恢复 209 做马系第二家族证据样本，整条九族/旧入口仍未关闭 |
...
| VS-070 Stage 2-3 前表现整改正式旅程 | 待实现 | 冷启动正式 P1/P2 档串联装备 hover、宠物 UI/动画、五角色动作和技能 HUD，跨页/跨关/重载一致 | M-036、M-042、M-044、M-047、M-049、M-052、VS-066..069 | `TASK-SLICE-200` | 只在所有前置/动态生成子 task 完成后执行；自动旅程和 940×590 人工验收全通过后才恢复 Stage 2-3 |
