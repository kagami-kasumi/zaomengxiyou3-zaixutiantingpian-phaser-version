...
| VS-060 关卡内五功能入口闭环 | 可开始 | 设置、技能、背包、法宝、宠物在正式关卡内按原版状态可点击并正确暂停/返回 | M-016、M-035、M-043、M-052 | `TASK-SETTINGS-067` 已闭合 574/371/444、owner、门禁、暂停/返回；实现父任务拆为 `TASK-SLICE-156A..C` | 先接五真 HUD pointer，再接全局 SetMenu/原版单页会话语义，最后在五关做 P1/P2 逐状态校准；不得保留现代可见跨页 host |
