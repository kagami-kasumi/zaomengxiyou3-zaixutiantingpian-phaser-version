...
| VS-067 宠物真 UI 与真动画闭环 | 待机制 | 正式 P1/P2 宠物页/战斗 UI 可见，所有已支持物种/形态的适用本体与技能动作使用恢复源真时间轴 | M-016、M-034、M-035、M-042、M-049、M-052 | `TASK-SETTINGS-191/193`、`TASK-SLICE-192A/192B/194`、193 生成的逐资源族证据/实现 task | 175A/180 单页证据保留但不能否定正式路径反证；先定位 UI 不可见根因，动画必须按恢复源族分 task，不一次接入九物种 |
