...
| VS-052 启动与存档槽闭环 | 整改中 | EXE 启动后可新建、读取、删除独立存档槽；新建时确定人数/角色并安全处理迁移/损坏数据 | M-005、M-006、M-044、M-050 | `SaveSlotSystem.ts`、`SaveSlotScene.ts`、`SaveSystem.ts`、`TASK-SETTINGS-065/ARCH-011/SLICE-151` | 既有六槽隔离、当前槽和损坏保护保持；待补 `PartyConfiguration`、新建存档 1P/2P 与 P1/P2 选角、旧 V4 迁移和真 UI 运行验收 |
