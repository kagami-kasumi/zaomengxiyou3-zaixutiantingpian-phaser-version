...
| VS-054 完整功能 UI 闭环 | 待机制（业务已完成） | 背包、装备、宠物、心法/技能和法宝从正式导航可达，具备真 UI、双玩家边界和存档集成 | M-016、M-036、M-037、M-041、M-042、M-043、M-052 | 既有页面/host/V5/自动旅程；`TASK-SLICE-142/154/176`；175 审计；175A 宠物、175B 法宝、175C 宿主、175D 技能 verified 真值 | 四组证据阻塞已解除，但 TASK-SLICE-180..183 尚未实现；宠物/法宝/地图 host/技能现代覆盖或手写视觉源仍待整改。逐页直接消费与运行验收完成前不宣称完整原生化 |
| VS-055 技能页面 UI 原生化闭环 | 待机制（业务完成；真值已闭合，直连待 183） | 技能总页、主动页、绑定页和被动页复用原图片视觉，并且只显示当前存档活动 owner 的当前角色技能 | M-016、M-041、M-044、M-052、PG-007、PG-009、PG-010 | `skill-ui-native-index.md`、`task-settings-175d.skill-pages` 250 对象/32 状态 verified、`TASK-SLICE-143/152/154-visual-audit.md` | 175D 已解除 manifest 阻塞；现代 layout/view 仍须由 183 直接消费真值、删除手写视觉源并完成 P1/P2/逐状态 940×590 回测，完成前不恢复“已完成” |
...
| VS-059 天庭地图四服务页闭环 | 待机制（业务/旧视觉审计已完成） | 完成丹药、商城、设置、任务四入口的原版内容、真 UI、离线边界、正式往返与存档影响 | M-035、M-044、M-046、M-052、VS-064 | 四页六段证据、`TASK-SLICE-155A..D`；`TASK-SETTINGS-175E..H` | 丹药 175E、商城 175F、设置 175G 已分别闭合 132/132/19 对象与 26/31/23 状态 verified 真值；任务仍待 175H，四页 manifest 直连与逐态实现验收完成前不使用“真 UI 全部通过” |
| VS-060 关卡内五功能入口闭环 | 业务已完成；真值已闭合，宿主整改待 182 | 设置、技能、背包、法宝、宠物在正式关卡内按原版状态可点击并正确暂停/返回 | M-016、M-035、M-043、M-052 | `task-settings-175c.stage-feature-host` 25 对象/42 状态 verified；`TASK-SLICE-156A..C`、165A/176 的 router、五关、启动竞态与去重层证据 | 固定 HUD 命中、P1/P2 owner/门禁、暂停和返回保持；175C 冻结地图态共享 chrome 为未批准差异，由 182 删除并做逐态回测 |
...
| VS-062 五角色战斗 UI 与技能真动画闭环 | 待机制（主体视觉已完成） | 五角色本体、战斗 UI、普攻、全部已实现技能及附属对象逐状态真动画闭合，并验证可见对象对应实际行为 | M-018..M-025、M-034、M-035、M-047、M-049 | 069/158 视觉链、163/164 远程 J 行为复核；176 的 Role5 selector 语义纠错；173 verified 影分身真值；173A1/173A3 TestScene 投射；173A2 正式 Runtime；174 几何/二维结算 | 173A 已闭合 Role1 影分身正式链；174 已闭合四个 detached 普攻唯一几何 owner、verified 空间真值、Role5 二维命中与共享结算。Role5 完整装备驱动的剑形内部动画仍未越级宣称 |
