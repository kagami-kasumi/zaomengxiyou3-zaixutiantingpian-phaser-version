...
| VS-059 天庭地图四服务页闭环 | 待机制 | 完成丹药、商城、设置、任务四入口的原版内容、真 UI、离线边界、正式往返与存档影响 | M-035、M-044、M-046、M-052 | `GOAL-037` / `TASK-SETTINGS-066`，实现父任务 `TASK-SLICE-155` | 现有完整功能 UI 14 页不包含这四页；先闭合六段证据，再逐页拆 0-compact Goal |
