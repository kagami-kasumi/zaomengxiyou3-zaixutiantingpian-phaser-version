...
| VS-050 Stage 1 战斗可读与可通关闭环 | 待实现 | 用现有三关证明主要攻击可读、死亡原因可解释、默认 Role1 无调试能力三次 1-1 至少两次通关 | M-032、M-033、M-040、M-047、M-048、`stage1-combat-calibration.md` | `TASK-SLICE-130` | 六段证据已确认三关模型分裂、1-2 同帧接触爆发和原版攻击/保护/续航合同；实现先统一 owner，再记录 1-2/1-3 难度与失败分布 |
| VS-051 正式核心战斗 HUD | 待机制 | 在 Stage 1 三关显示双玩家 HP/MP/经验/等级、技能和重要敌人状态 | M-015、M-016、M-040、M-049 | `TASK-SETTINGS-055` → `TASK-SLICE-131` | 核心 HUD 与完整背包/宠物页面分开；双玩家所有权、场景生命周期和真资源必须闭合 |
