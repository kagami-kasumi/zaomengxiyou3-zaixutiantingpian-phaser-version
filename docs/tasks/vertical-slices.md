...
| VS-067 宠物真 UI 与真动画闭环 | 部分实现 | 正式 P1/P2 宠物页/战斗 UI 可见，动态头像由逐状态递归真值投影，所有已支持物种/形态的适用本体与技能动作使用恢复源真时间轴 | M-016、M-034、M-035、M-042、M-049、M-052 | `TASK-SETTINGS-191/193/193A/193C/201/205/207/209`、`TASK-SLICE-192A/192B/193B/193D/194/202/208/208A`、`TASK-ARCH-203/204A/204B/206` | PG-017 V2 已独立检出 208 未消费猴系 `attackRange`/追击语义并让 P1R 正确为 1；208A 整改并修订 Skill 后才恢复 209，整条九族/旧入口仍未关闭 |
