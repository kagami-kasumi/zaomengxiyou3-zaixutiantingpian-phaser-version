...
| VS-057 Stage 2-3 可玩关卡闭环 | 待机制 | 由六段证据决定 Stage 2-3 真场景、流程、怪物/机关、结果与保存的首个可玩范围 | M-026、M-027、M-030、M-035、M-044、`levels-index.md` | `GOAL-025` / `TASK-SETTINGS-064` 当前只做逆向 | 未读取目标资料；禁止按 Stage 2-2 类推，证据闭合后再拆实现与校准 Goal |
...
| VS-061 已完成关卡怪物真动画闭环 | 部分完成 | Stage 1-1/1-2/1-3 全部实际怪物及攻击对象真动画闭合，Stage 2-1/2-2 防回归 | M-030、M-034、M-035、`stage1-monster-visuals-index.md` | `TASK-SETTINGS-068` 已闭合 7 本体/167 独立视觉帧、16 对象/171 帧、3 碰撞根；`TASK-SLICE-157A/B` 已接入 Stage 1-1/1-2 六怪、136 本体帧与 12 对象 147 帧，`GOAL-062..063 / TASK-SLICE-157C..D` 继续 Stage 1-3 与最终回归 | 当前只激活 Stage 1-3；禁止用代表性怪物、单帧或 Arc/Text 替代全集 |
| VS-062 五角色战斗 UI 与技能真动画闭环 | 待机制 | 五角色本体、战斗 UI、普攻、全部已实现技能及附属对象逐状态真动画闭合 | M-018..M-025、M-034、M-035、M-047、M-049 | `GOAL-040` / `TASK-SETTINGS-069`，实现父任务 `TASK-SLICE-158` | 逻辑技能已完成不等于视觉完成；Role1 部分真资源与其余占位项均需按全集复核 |
| VS-063 前置体验本地存档正式旅程 | 可开始但后置 | 复用六槽 V6 `localStorage`，验证新增页面事务、双方数据和关卡进度跨应用重启保持 | M-044、M-050、VS-052、VS-059..VS-062 | `GOAL-041` / `TASK-SLICE-159` | 存档基础已实现，不重复造 schema；必须等待四个实现父任务及全部子 task 归档后执行 |
