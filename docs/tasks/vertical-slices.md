...
| VS-067 宠物真 UI 与真动画闭环 | 部分实现 | 正式 P1/P2 宠物页/战斗 UI 可见，动态头像由逐状态递归真值投影，所有已支持物种/形态的适用本体与技能动作使用恢复源真时间轴 | M-016、M-034、M-035、M-042、M-049、M-052 | `TASK-SETTINGS-191/193/193A/193C/201/205/207/209`、`TASK-SLICE-192A/192B/193B/193D/194/202/208/208A/210`、`TASK-ARCH-203/204A/204B/206` | 208A 已让猴系四形态 × P1/P2 语义 P1R=0；210 已让马系四形态 × P1/P2 语义 P1H=0，全部继承技能、冰效/奥义、真实命中伤害和 `PetCombatSnapshot/actionToken` 真动画同链。整条九族/旧入口仍未关闭；下一执行项转为 211 战斗反馈真值，不提前外推其余家族 |
...
| VS-071 怪物命中可见反馈与连击闭环 | 待机制 | Role、宠物与法宝只有在实际扣减怪物 HP 后才共享 hurt/HP、普通/暴击伤害数字与原版连击反馈，结果页记录真实最高连击 | M-032、M-035、M-049、M-053 | `TASK-SETTINGS-211`、`TASK-SLICE-212`；执行前由 209 生成的 210 闭合马系正式伤害 | 211 从 `OtherMat1.swf` 与 AS3 producer/queue/view/reset 链生成 verified 真值；212 用 source-isolated trace 证明可见反馈与 HP delta 一一对应，miss/0/dedup/dead 不得假显示 |
