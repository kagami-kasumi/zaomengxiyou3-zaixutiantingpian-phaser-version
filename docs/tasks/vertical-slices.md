...
| VS-064 完整背包资源基础闭环 | 已完成 | 原版 1.1 可入包资源全集使用统一身份、真图标、四分类、堆叠/实例、容量、P1/P2 owner 与 V6 往返，并能被丹药/商城/任务/掉落/工坊复用 | M-035、M-036、M-037、M-044、M-052 | `GOAL-049/050`、166A..D、165D、168A/B、170A..D；176 继续直接消费 170B1 verified `soul-value` | 176 最终按恢复 SWF `DefineEditText 214 / txt_lh` 校正为 15px `FZCuYuan-M03` 白字、左对齐、字段左上各 2px 内边距，长数字向右展开；3 项原版图标缺陷继续排除，背包业务/owner/事务未重开 |
