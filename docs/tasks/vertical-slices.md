...
| VS-052 启动与存档槽闭环 | 已完成；真值直连待 187 | EXE 启动后可新建、读取、删除独立存档槽；新建时确定人数/角色并安全处理损坏数据 | M-005、M-006、M-044、M-050 | 当前单 schema、`SavePartyCreationView.ts`、`save-party-flow-index.md`、`task-settings-175i.party-creation`、`TASK-SLICE-151-visual-audit.md` | 业务、原子建槽、1P/2P、取消/重载已闭合；175I 已冻结 20 对象/30 状态 verified 真值，现有 view 手写坐标/命中真值源待 187 删除后再恢复整页直接消费结论 |
...
| VS-054 完整功能 UI 闭环 | 待机制（业务已完成） | 背包、装备、宠物、心法/技能和法宝从正式导航可达，具备真 UI、双玩家边界和存档集成 | M-016、M-036、M-037、M-041、M-042、M-043、M-052 | 既有页面/host/V5/自动旅程；`TASK-SLICE-142/154/176/180/181/182`；175 审计；175A 宠物、175B 法宝、175C 宿主、175D 技能 verified 真值 | 宠物页、法宝页与功能宿主已直接消费真值并完成运行验收；TASK-SLICE-183 的技能现代覆盖/手写视觉源仍待整改。其余逐页闭合前不宣称完整原生化 |
