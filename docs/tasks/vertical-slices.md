...
| VS-046 Stage 1-2 普通关卡闭环 | 已完成 | 实现五停点 46 怪、双 boss 普通门门禁、统一失败与普通胜利存档闭环 | M-026、M-027、M-030、M-044、VS-045、`levels-index.md` | `Stage12FlowSystem.ts`、gameplay/result bridges、V3 进度扩展与 `stage12-flow-tests.ts` | 五批按 8/11/12/13/2 推进；Monster4+Monster2 全灭后门可用；1P/2P 全灭失败不解锁，普通胜利幂等解锁 1-3；入口运行时加载和移动验证通过 |
