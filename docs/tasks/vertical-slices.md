...
| VS-054 完整功能 UI 闭环 | 已完成 | 背包、装备、宠物、心法/技能和法宝从正式导航可达，具备真 UI、双玩家边界和存档集成 | M-016、M-036、M-037、M-041、M-042、M-043、M-052 | 既有页面/host/V5/自动旅程；`TASK-SLICE-142/154` 用户反馈整改 | 工坊原图与 P1/P2 风格保持；技能页按页面/角色加载、动态字段无叠字、五角色心法和 owner 灵魂均闭合 |
| VS-055 技能页面 UI 原生化闭环 | 已完成 | 技能总页、主动页、绑定页和被动页复用原图片视觉，并且只显示当前存档活动 owner 的当前角色技能 | M-016、M-041、M-044、M-052、PG-007、PG-009、PG-010 | `skill-ui-native-index.md`、`TASK-SLICE-143/152/154-visual-audit.md`、`FormalSkillPageSystem.ts`、`FormalSkillPageView.ts`、`FormalSoulBalanceView.ts`、`PlayerSoulSystem.ts` | 250/868/213 静态与动态 child 分离；五角色两心法、双人 P1/P2、角色级 30 帧按需加载与 940×590 零 console 已闭合；V6 `player.soulCount`、技能/工坊共享余额投影、统一消费、跨页 model 刷新、双 owner 与跨功能重载旅程全部闭合 |
...
| VS-062 五角色战斗 UI 与技能真动画闭环 | 已完成 | 五角色本体、战斗 UI、普攻、全部已实现技能及附属对象逐状态真动画闭合，并验证可见对象对应实际行为 | M-018..M-025、M-034、M-035、M-047、M-049 | 069/158视觉链、`TASK-SLICE-163/164`远程J行为复核 | 真视觉保持闭合；163/164已修复固定world与移动projectile命中，行为复核缺口清零 |
| VS-063 前置体验本地存档正式旅程 | 已完成 | 复用六槽 V6 `localStorage`，验证新增页面事务、双方数据和关卡进度跨应用重启保持 | M-044、M-050、VS-052、VS-059..VS-062 | `TASK-SLICE-159`、`pre-stage23-save-journey-tests.ts`、`TASK-SLICE-159/visual-audit.md` | 四地图服务、五战斗入口、P1/P2 事务、1-2 解锁、设置独立 owner、V6 重启、临时状态排除与损坏槽保护闭合；940×590 唐僧/白龙正式旅程零 console |
| VS-064 完整背包资源基础闭环 | 已完成 | 原版 1.1 可入包资源全集使用统一身份、真图标、四分类、堆叠/实例、容量、P1/P2 owner 与 V6 往返，并能被丹药/商城/任务/掉落/工坊复用 | M-035、M-036、M-037、M-044、M-052 | `GOAL-049/050` 闭合 431 项权威目录、428 真图标、统一事务、双 owner 与 V6；166A..D 闭合正式背包；165D 闭合炼丹炉第二消费者与 verified 真值；168A/168B 证明四页动态槽继续复用同一真图标投影，用户逐次截图校准后左侧使用 63×62 投影覆盖白色内沿、只留外框，并支持逐槽点击退回，右栏保持正式 32×32 网格投影 | 3 项原版图标缺陷排除；正式背包与炼丹炉均消费同一只读 cell/grid/icon/quantity 投影，25 格/四分类/五页、单一 `n/5`、双 owner、战斗即时/地图回退、工坊暂存/逐槽返还和 940×590 已通过 |
