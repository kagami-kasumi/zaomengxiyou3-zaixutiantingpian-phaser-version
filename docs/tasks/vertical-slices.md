...
| VS-060 关卡内五功能入口闭环 | 进行中 | 设置、技能、背包、法宝、宠物在正式关卡内按原版状态可点击并正确暂停/返回 | M-016、M-035、M-043、M-052 | `TASK-SLICE-156A` 已闭合 574 五真 pointer、P2 镜像、共享 router/门禁；`156B/C` 待完成 | 当前接全局 SetMenu/原版单页会话语义，随后在五关做 P1/P2 逐状态校准；不得保留现代可见跨页 host |
