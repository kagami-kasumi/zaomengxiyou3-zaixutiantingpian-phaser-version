...
| VS-067 宠物真 UI 与真动画闭环 | 部分实现 | 正式 P1/P2 宠物页/战斗 UI 可见，动态头像由逐状态递归真值投影，所有已支持物种/形态的适用本体与技能动作使用恢复源真时间轴 | M-016、M-034、M-035、M-042、M-049、M-052 | `TASK-SETTINGS-191/193/193A/193C/201/205/207/209`、`TASK-SLICE-192A/192B/193B/193D/194/202/208/208A/210/210A`、`TASK-ARCH-203/204A/204B/206` | 208A 已让猴系四形态 × P1/P2 语义 P1R=0；210 已让马系四形态 × P1/P2 语义 P1H=0；210A 又补齐怪物 active attack 对出战宠物的范围/防御/去重伤害和 HP/hurt/dead 生命周期。整条九族/旧入口仍未关闭；下一执行项转为 211 战斗反馈真值，不提前外推其余家族 |
...
| VS-070 Stage 2-3 前表现整改正式旅程 | 待实现 | 冷启动正式 P1/P2 档串联装备 hover、宠物 UI/动画与实际伤害反馈、五角色动作、伤害数字/连击和技能 HUD，跨页/跨关/重载一致 | M-036、M-042、M-044、M-047、M-049、M-052、M-053、VS-066..069、VS-071 | `TASK-SLICE-200` | 只在所有前置/动态生成子 task 完成后执行；自动旅程和 940×590 人工验收全通过后才恢复 Stage 2-3 |
| VS-071 怪物命中可见反馈与连击闭环 | 待实现 | Role、宠物与法宝只有在实际扣减怪物 HP 后才共享 hurt/HP、普通/暴击伤害数字与原版连击反馈，结果页记录真实最高连击 | M-032、M-035、M-049、M-053 | `TASK-SETTINGS-211` 已完成、`TASK-SLICE-212` Ready；209/210 已闭合马系正式伤害 | 211 的 23 状态 verified truth 已闭合 `OtherMat1.swf` 字形/显示列表/时序/来源矩阵；212 用 source-isolated trace 证明可见反馈与 HP delta 一一对应，miss/0/dedup/dead 不得假显示 |
