...
| VS-064 完整背包资源基础闭环 | 已完成 | 原版 1.1 可入包资源全集使用统一身份、真图标、四分类、堆叠/实例、容量、P1/P2 owner 与当前 schema 往返，并能被丹药/商城/任务/掉落/工坊复用 | M-035、M-036、M-037、M-044、M-052 | `GOAL-049/050`、166A..D、165D、168A/B、170A..D、171B、178；176 继续直接消费 170B1 verified `soul-value` | 171B/178 已补齐实例 override 与当前 schema 往返；176 的原字段字体/内边距保持；3 项原版图标缺陷继续排除，背包业务/owner/事务未重开 |
