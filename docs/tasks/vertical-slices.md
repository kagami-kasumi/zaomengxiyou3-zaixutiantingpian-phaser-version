...
| VS-061 已完成关卡怪物真动画闭环 | 部分完成 | Stage 1-1/1-2/1-3 全部实际怪物及攻击对象真动画闭合，Stage 2-1/2-2 防回归 | M-030、M-034、M-035、`stage1-monster-visuals-index.md` | `TASK-SETTINGS-068` 已闭合 7 本体/167 独立视觉帧、16 对象/171 帧、3 碰撞根；`TASK-SLICE-157A/B` 已接入 Stage 1-1/1-2 六怪、136 本体帧与 12 对象 147 帧，`TASK-SLICE-157C..D` 继续 Stage 1-3 与最终回归 | 当前只激活 Stage 1-3；禁止用代表性怪物、单帧或 Arc/Text 替代全集 |
| VS-062 五角色战斗 UI 与技能真动画闭环 | 待机制 | 五角色本体、战斗 UI、普攻、全部已实现技能及附属对象逐状态真动画闭合 | M-018..M-025、M-034、M-035、M-047、M-049 | `TASK-SETTINGS-069`，实现父任务 `TASK-SLICE-158` | 逻辑技能已完成不等于视觉完成；Role1 部分真资源与其余占位项均需按全集复核 |
...
| VS-065 通用可玩关卡运行框架 | 待实现 | 五个现有关卡与全部后续关卡复用共同 Runtime，关卡只声明定义、遭遇和有证据的窄 adapter | M-014、M-026、M-027、M-029、M-035、M-044、PG-013 | `TASK-ARCH-016A..D` | 当前只有 LevelLifecycle/Result 等局部 owner；须完成合同、双关试点、Stage 2、1-1/TestScene 四批并在未来新关卡复查 |
