...
| VS-054 完整功能 UI 闭环 | 待机制（业务已完成） | 背包、装备、宠物、心法/技能和法宝从正式导航可达，具备真 UI、双玩家边界和存档集成 | M-016、M-036、M-037、M-041、M-042、M-043、M-052 | 既有页面/host/V5/自动旅程；`TASK-SLICE-142/154/176/180/181/182/183`；175 审计；175A 宠物、175B 法宝、175C 宿主、175D 技能 verified 真值 | 宠物页、法宝页、功能宿主与技能四页已直接消费真值并完成运行验收；其余逐页闭合前不宣称完整原生化 |
...
| VS-059 天庭地图四服务页闭环 | 待机制（业务与四页真值已完成） | 完成丹药、商城、设置、任务四入口的原版内容、真 UI、离线边界、正式往返与存档影响 | M-035、M-044、M-046、M-052、VS-064 | 四页六段证据、`TASK-SLICE-155A..D`；`TASK-SETTINGS-175E..H`；商城 `TASK-SLICE-184`；设置 `TASK-SLICE-185`；任务 `TASK-SLICE-186` | 商城、设置与任务已分别直接消费 132/31、19/23、45/28 对象/状态真值并完成逐态运行验收；丹药页面 manifest 直连完成前不使用“四服务真 UI 全部通过” |
