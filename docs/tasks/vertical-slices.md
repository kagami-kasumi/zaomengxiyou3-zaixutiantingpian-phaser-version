...
| VS-052 启动与存档槽闭环 | 已完成 | EXE 启动后可新建、读取、删除独立存档槽；新建时确定人数/角色并安全处理迁移/损坏数据 | M-005、M-006、M-044、M-050 | `PartyConfigurationSystem.ts`、`SaveProfileDraftSystem.ts`、`SaveSlotSystem.ts`、`SaveSlotScene.ts`、`SavePartyCreationView.ts`、`SaveSystem.ts`、`save-party-flow-index.md`、`TASK-SLICE-151-visual-audit.md` | V5 party、V1..V4/旧单槽迁移、P2 保留、严格拒读、原子建槽、character 1149/901 真 UI、1P/2P 组合、取消/重载与 940×590 零 console 全部闭合 |
...
| VS-054 完整功能 UI 闭环 | 待机制（业务已完成） | 背包、装备、宠物、心法/技能和法宝从正式导航可达，具备真 UI、双玩家边界和存档集成 | M-016、M-036、M-037、M-041、M-042、M-043、M-052 | 既有页面/host/V5/自动旅程；`TASK-SLICE-142/154/176` 用户反馈整改；`TASK-SETTINGS-175` 复评重开证据等级 | 176 已关闭 HUD/设置双层与背包灵魂值错位；宠物/法宝/功能 host 的现代占位与 legacy manifest 债务待 175 分级，未达 verified 前不再宣称完整原生化 |
| VS-055 技能页面 UI 原生化闭环 | 待机制（业务/旧视觉审计已完成） | 技能总页、主动页、绑定页和被动页复用原图片视觉，并且只显示当前存档活动 owner 的当前角色技能 | M-016、M-041、M-044、M-052、PG-007、PG-009、PG-010 | `skill-ui-native-index.md`、`TASK-SLICE-143/152/154-visual-audit.md`、`FormalSkillPageSystem.ts`、`FormalSkillPageView.ts`、`FormalSoulBalanceView.ts`、`PlayerSoulSystem.ts`、`TASK-SETTINGS-175` | 既有资源/业务/双 owner/V6 回归保持；按 2026-08-08 新门禁补齐或验证机器真值前，状态只表示 legacy 视觉审计已完成，不越级宣称当前原生化闭环 |
...
| VS-059 天庭地图四服务页闭环 | 待机制（业务/旧视觉审计已完成） | 完成丹药、商城、设置、任务四入口的原版内容、真 UI、离线边界、正式往返与存档影响 | M-035、M-044、M-046、M-052、VS-064 | 四页六段证据、背包前置与 `TASK-SLICE-155A..D` 全部归档；`TASK-SETTINGS-175` 复核当前机器真值门禁 | 四页内容、离线/持久化边界和正式往返保持；逐页 verified manifest 与可见占位分级完成前，不再使用“真 UI 全部通过”的关闭措辞 |
| VS-060 关卡内五功能入口闭环 | 已完成 | 设置、技能、背包、法宝、宠物在正式关卡内按原版状态可点击并正确暂停/返回 | M-016、M-035、M-043、M-052 | `TASK-SLICE-156A..C` 的 574/371/444、共享 router 与五关合同；`TASK-SLICE-165A/176` 的 pointer 路由、启动竞态与重复 normal 层修复 | 固定 HUD 命中、P1/P2 owner/门禁、暂停和返回保持；176 的 940×590 复验确认 HUD/设置各只有一份 normal 可见层且 console 为 0 |
...
| VS-062 五角色战斗 UI 与技能真动画闭环 | 待机制（主体视觉已完成） | 五角色本体、战斗 UI、普攻、全部已实现技能及附属对象逐状态真动画闭合，并验证可见对象对应实际行为 | M-018..M-025、M-034、M-035、M-047、M-049 | 069/158 视觉链、163/164 远程 J 行为复核；176 的 Role5 selector 语义纠错；173 verified 影分身真值；173A1/173A3 TestScene 投射；`TASK-SLICE-173A2/TASK-ARCH-174` | 173A1/173A3 已闭合 Role1 五个静态候选、90 tick、hit1/hit2、矩阵、共享投射和 940×590 TestScene 证据；剩余正式接入由 173A2，普攻几何/Role5 projectile 由 174 继续。Role5 完整装备驱动的剑形内部动画仍未越级宣称 |
