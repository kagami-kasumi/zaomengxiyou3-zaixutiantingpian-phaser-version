...
| VS-052 启动与存档槽闭环 | 整改中 | EXE 启动后可新建、读取、删除独立存档槽；新建时确定人数/角色并安全处理迁移/损坏数据 | M-005、M-006、M-044、M-050 | `SaveSlotSystem.ts`、`SaveSlotScene.ts`、`SaveSystem.ts`、`save-party-flow-index.md`、`TASK-ARCH-011/SLICE-151` | 人数/选角/原子建档、旧 V1..V4 默认 1P 与 character 1149/901 真 UI 合同已闭合；待 schema/迁移实现和 1P/2P 运行验收 |
