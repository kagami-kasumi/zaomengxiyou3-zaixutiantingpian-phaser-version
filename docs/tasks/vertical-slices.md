...
| VS-066 装备悬停数值闭环 | 部分实现 | 正式背包已穿戴槽/装备格及原版存在的其他消费者 hover 显示同一装备实例的权威有效数值 | M-036、M-037、M-052 | `TASK-SETTINGS-189`（已完成）、`TASK-SLICE-190A/190B1`（已完成）、`TASK-SLICE-190B2..B4` | 190A 已闭合正式背包；190B1 已闭合强化页共享右 grid/目标槽、随机 +3、P1/P2、失败 +2 即时刷新与重开。合成/分解/打造继续由 190B2..B4 闭合，不新建 equipment owner |
