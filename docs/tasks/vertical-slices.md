...
| VS-067 宠物真 UI 与真动画闭环 | 待实现 | 正式 P1/P2 宠物页/战斗 UI 可见，所有已支持物种/形态的适用本体与技能动作使用恢复源真时间轴 | M-016、M-034、M-035、M-042、M-049、M-052 | `TASK-SETTINGS-191/193`、`TASK-SLICE-192A/192B/194`、193 生成的逐资源族证据/实现 task | 191 已证 932 页面链可见并冻结独立 character 662 战斗 HUD 真值；192A 补正式冷启动旅程，192B 恢复 662，动画仍须按 193 恢复源族分 task |
