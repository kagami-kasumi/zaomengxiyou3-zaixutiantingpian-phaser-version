...
| VS-066 装备悬停数值闭环 | 部分实现 | 正式背包已穿戴槽/装备格及原版存在的其他消费者 hover 显示同一装备实例的权威有效数值 | M-036、M-037、M-052 | `TASK-SETTINGS-189`（已完成）、`TASK-SLICE-190A`（已完成）、`TASK-SLICE-190B1..B4` | 190A 已闭合正式背包格/已穿戴槽、随机/+3 实例、P1/P2、边缘与刷新；工坊四页继续由 190B1..B4 闭合，不新建 equipment owner |
