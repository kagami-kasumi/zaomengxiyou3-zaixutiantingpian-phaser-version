...
| VS-054 完整功能 UI 闭环 | 待机制（业务已完成） | 背包、装备、宠物、心法/技能和法宝从正式导航可达，具备真 UI、双玩家边界和存档集成 | M-016、M-036、M-037、M-041、M-042、M-043、M-052 | 既有页面/host/V5/自动旅程；`TASK-SLICE-142/154` 用户反馈整改；`TASK-SETTINGS-175` 复评重开证据等级 | 正式可达、双 owner 和存档业务保持；宠物/法宝/功能 host 的现代占位与 legacy manifest 债务待 175 分级，未达 verified 前不再宣称完整原生化 |
...
| VS-060 关卡内五功能入口闭环 | 已完成 | 设置、技能、背包、法宝、宠物在正式关卡内按原版状态可点击并正确暂停/返回 | M-016、M-035、M-043、M-052 | `TASK-SLICE-156A..C` 的 574/371/444、共享 router 与五关合同；`TASK-SLICE-165A` 的场景级 pointer 路由、设置启动竞态修复和 940×590 五按钮真实旅程 | 固定 HUD 命中、P1/P2 owner/门禁、暂停、同键、Escape 和返回已闭合；五个 P1 pointer 均真实打开并关闭回 Role1 关卡，console 零 warning/error；战斗现代可见跨页 host 为零 |
...
| VS-062 五角色战斗 UI 与技能真动画闭环 | 待机制（主体视觉已完成） | 五角色本体、战斗 UI、普攻、全部已实现技能及附属对象逐状态真动画闭合，并验证可见对象对应实际行为 | M-018..M-025、M-034、M-035、M-047、M-049 | 069/158 视觉链、163/164 远程 J 行为复核；`TASK-SETTINGS-173/TASK-SLICE-173A/TASK-ARCH-174` | 既有真资源/主体动画保持；Role1 影分身正式 identity/action、世界特效普攻几何单源与 Role5 二维 projectile 结算关闭后再恢复“行为缺口清零” |
| VS-063 前置体验本地存档正式旅程 | 待机制（V6 主旅程已完成） | 复用六槽本地存档，验证新增页面事务、双方数据和关卡进度跨应用重启保持 | M-044、M-050、VS-052、VS-059..VS-062 | `TASK-SLICE-159`、`pre-stage23-save-journey-tests.ts`、`TASK-SLICE-159/visual-audit.md`、`TASK-SLICE-171B` | 原 V6 主旅程保持；171B 完成比例字段 V6→V7、打造继承属性、灵魂整数和 P1/P2 重载回归后恢复关闭状态 |
| VS-064 完整背包资源基础闭环 | 已完成 | 原版 1.1 可入包资源全集使用统一身份、真图标、四分类、堆叠/实例、容量、P1/P2 owner 与 V6 往返，并能被丹药/商城/任务/掉落/工坊复用 | M-035、M-036、M-037、M-044、M-052 | `GOAL-049/050` 闭合 431 项权威目录、428 真图标、统一事务、双 owner 与 V6；166A..D 闭合正式背包；165D 闭合炼丹炉第二消费者与 verified 真值；168A/168B 证明四页动态槽继续复用同一真图标投影；170A/170B1/170B2 冻结装备数据/页面/视觉证据；170C 接入 164 项数据与 111 character；170D 闭合 63 对象/9 状态真值直连和全装备正式页面逐状态视觉 | 3 项原版背包图标缺陷继续排除；正式背包与炼丹炉共享只读投影的既有闭环不变；后续四事务只消费目录，不重开本切片 |
