...
| LINE-CORE-PROGRESSION-COMPLETION | Active | Stage 2-3 前完成炼丹炉左页与四功能、全装备 UI/数值、五角色成长、存档扩展、关卡左下五入口、用户确认的 UI 整改及复评确认的同线纠错 | TASK-SETTINGS-175H | `feature-line-coverage/LINE-CORE-PROGRESSION-COMPLETION.md` | 无 | 宠物、法宝、功能宿主、技能、丹药、商城、设置已有 verified 真值；设置为 19 对象/23 状态，下一步任务 85 真值迁移 |
