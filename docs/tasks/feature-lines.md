...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、怪物/角色/宠物伤害数字与连击反馈、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SLICE-214C4 | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 214C3公共地面移动/主子trace/P1GS通过；214C4实施初阶真实战斗，父级全量合同保留 | 214 必须保持九对象 `ltwj`、gate-only MP `qlaoyi`、P1/P2 owner 与正式/TestScene 同源；215/216 不抢占当前 Ready |
