...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-ARCH-204B | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 204A 已接猴/马 8 形态；其余 Behavior、消费者与旧入口尚未闭合 | 连续执行 204B..F 至 pet all=0，再恢复强制 Skill 的 193E |
