...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、宠物战斗公共类 P1、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SLICE-202 | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | character 657 新真值尚未进入正式 HUD；宠物公共类 P1 尚未实施；其余七族动画待完成 | 202 直接消费 201 verified 真值，删除身体 atlas/联合 bounds 头像替代 |
