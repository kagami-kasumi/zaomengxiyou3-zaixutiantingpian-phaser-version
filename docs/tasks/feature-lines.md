...
| LINE-CORE-PROGRESSION-COMPLETION | Active | Stage 2-3 前完成炼丹炉左页与四功能、全装备 UI/数值、五角色成长、存档扩展、关卡左下五入口、用户确认的 UI 整改及复评确认的同线纠错 | TASK-SLICE-188 | `feature-line-coverage/LINE-CORE-PROGRESSION-COMPLETION.md` | 无 | 建档/选角已直接消费 20 对象/30 状态真值；当前线最后一个已知 UI 真值缺口为丹药页 990/969/1006 manifest 直连 |
