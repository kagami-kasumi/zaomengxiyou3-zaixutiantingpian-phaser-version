...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、怪物/角色/宠物伤害数字与连击反馈、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SETTINGS-215 | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 青龙44合同/P1G已闭合；继续角色/宠物承伤数字真值 | 215完成后216；承伤数字闭合后再生成下一未闭合宠物家族 |
