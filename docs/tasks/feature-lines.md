...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SETTINGS-193E | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 猴系与马系真值/运行投影已闭合；其余七族待完成 | 193E 只闭合 UFO 本体/技能对象逐帧 verified 真值，不接入现代动画 |
