...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、宠物战斗公共类 P1、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SETTINGS-193E | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 其余七族动画待完成 | 203 的宠物公共类 P1 已通过；当前恢复 UFO 动画证据 193E |
