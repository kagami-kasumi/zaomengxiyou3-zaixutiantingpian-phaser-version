...
| LINE-CORE-PROGRESSION-COMPLETION | Active | Stage 2-3 前完成炼丹炉左页与四功能、全装备 UI/数值、五角色成长、存档扩展、关卡左下五入口和用户确认的 UI 整改 | TASK-SLICE-170C | `feature-line-coverage/LINE-CORE-PROGRESSION-COMPLETION.md` | 无 | 170A/170B1/170B2 已闭合 164 数据、页面真值与视觉 provenance；现直接接入唯一 owner、真资源和正式穿戴预览 |
