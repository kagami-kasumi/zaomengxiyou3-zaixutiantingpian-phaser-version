...
| LINE-CORE-PROGRESSION-COMPLETION | Active | Stage 2-3 前完成炼丹炉左页与四功能、全装备 UI/数值、五角色成长、存档扩展、关卡左下五入口、用户确认的 UI 整改及复评确认的同线纠错 | TASK-SETTINGS-175D | `feature-line-coverage/LINE-CORE-PROGRESSION-COMPLETION.md` | 无 | 宠物 932、法宝 596、功能宿主 574/371/444 已分别有 74/28/25 对象与 16/21/42 状态 verified 真值；下一步技能 250/868/417/213 真值迁移 |
