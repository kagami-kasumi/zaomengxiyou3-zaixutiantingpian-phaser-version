...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、怪物/角色/宠物伤害数字与连击反馈、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SLICE-224C | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 224A的17项/P1TA及224B的13项/P1TB通过→224C全32合同/五关联合Ready | 猴/马/青龙三族完成，玄龟等六族及194后续仍待；功能线保持Active |
