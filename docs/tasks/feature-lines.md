...
| LINE-CORE-PROGRESSION-COMPLETION | Active | Stage 2-3 前完成炼丹炉左页与四功能、全装备 UI/数值、五角色成长、存档扩展、关卡左下五入口、用户确认的 UI 整改及复评确认的同线纠错 | TASK-SLICE-187 | `feature-line-coverage/LINE-CORE-PROGRESSION-COMPLETION.md` | 无 | 宠物、法宝、功能宿主、技能四页、商城、设置与任务页已直接消费 verified 真值并删除现代覆盖/手写视觉源；下一项为建档/选角 |
