...
| LINE-CORE-PROGRESSION-COMPLETION | Active | Stage 2-3 前完成炼丹炉左页与四功能、全装备 UI/数值、五角色成长、存档扩展、关卡左下五入口和用户确认的 UI 整改 | TASK-SETTINGS-170B2 | `feature-line-coverage/LINE-CORE-PROGRESSION-COMPLETION.md` | 无 | 170B1 已闭合 63 对象、9 状态的正式页面 verified 真值；现闭合 164 图标与五角色适用穿戴资源 provenance |
