...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、怪物/角色/宠物伤害数字与连击反馈、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SETTINGS-213 | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 213/214 先闭合 dragon1..4；随后由 215/216 闭合角色/宠物承伤 `pnum` | 213 不修改现代实现；青龙证据 verified 后才激活 214，215/216 不抢占当前 Ready |
