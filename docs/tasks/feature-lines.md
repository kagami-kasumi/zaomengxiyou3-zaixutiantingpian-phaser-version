...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-ARCH-204C | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 204B 已闭合证据校正 Runtime 与猴马 8 形态；其余七族、消费者与旧入口仍待 204C..G | 完成 Dragon/Turtle/Ufo 全形态 Behavior 与私有效果清理，pet P1C=0 |
