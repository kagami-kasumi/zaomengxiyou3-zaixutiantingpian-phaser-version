...
| LINE-CORE-PROGRESSION-COMPLETION | Active | Stage 2-3 前完成炼丹炉左页与四功能、全装备 UI/数值、五角色成长、存档扩展、关卡左下五入口、用户确认的 UI 整改及复评确认的同线纠错 | TASK-SLICE-180 | `feature-line-coverage/LINE-CORE-PROGRESSION-COMPLETION.md` | 无 | 175A..I verified 真值迁移全部闭合；现开始 180..187 逐页 manifest 直连，先处理宠物页 |
