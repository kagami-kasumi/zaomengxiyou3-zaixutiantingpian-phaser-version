...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、怪物伤害数字/连击反馈、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SETTINGS-213 | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 212 已闭合统一命中反馈；下一步按完整家族方法先冻结 dragon1..4 的 verified 证据 | 213 不修改现代实现；青龙证据 verified 后才激活 214，禁止复制猴/马家族事实 |
