...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-ARCH-206 | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 205 已证明当前 nearest、全 roster CD、立即死亡卸载及窄 Behavior 合同需设计裁决，204B..F 不得先执行 | 完成 206 唯一设计与 gate 重基线，再恢复或替换最小 204B 实施批次 |
