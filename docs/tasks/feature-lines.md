...
| LINE-PRE-STAGE-2-3-PRESENTATION | Active | 在执行 Stage 2-3 前按用户复验闭合装备悬停数值、宠物页/战斗 UI 与真动画、完整宠物战斗公共类、五角色动作流畅度/视觉完整性、战斗技能 HUD 可见与原生化 | TASK-SLICE-208 | `feature-line-coverage/LINE-PRE-STAGE-2-3-PRESENTATION.md` | 207 已冻结猴系 41 项完整原版合同；正式 Runtime 消费、真普攻/伤害与 P1/P2 生命周期仍待 208 | 直接消费 207 verified 真值让 monkey1..4 在正式五关形成完整自主战斗闭环 |
