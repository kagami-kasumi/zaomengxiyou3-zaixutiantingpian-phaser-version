...
`TASK-SLICE-224A` 是当前 Ready 游戏执行项。执行合同见 [定义](task-definitions/TASK-SLICE-224A.md)。
...
| TASK-SLICE-224A | Ready | LINE-PRE-STAGE-2-3-PRESENTATION | 玄龟有界接续 | 玄龟公共入口/普攻/SLD/TXLJ | M-032、M-034、M-035、M-042、VS-012、VS-067 | 全族合同保留与本批独立交接 | TASK-SLICE-224B | [定义](task-definitions/TASK-SLICE-224A.md) |
