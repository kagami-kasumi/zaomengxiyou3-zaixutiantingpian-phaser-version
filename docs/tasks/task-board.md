...
`TASK-SETTINGS-175D` 是唯一 Ready 游戏 task；175C 已将战斗五入口/设置宿主闭合为 25 对象/42 状态 verified 真值，下一步只将技能 250/868/417/213 旧审计机械升级为当前 manifest。

## 待完成任务

| Task | 状态 | 功能条线 | 类型 | 目标 | 目标机制/切片 | 输出 | 下一步 | 定义 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TASK-SETTINGS-175D | Ready | LINE-CORE-PROGRESSION-COMPLETION | 技能页真值迁移 | 将 250/868/417/213 旧审计机械升级为当前 manifest | M-041、M-052、VS-055 | `task-settings-175d.skill-pages` verified manifest | TASK-SETTINGS-175E | [定义](task-definitions/TASK-SETTINGS-175D.md) |
