...
`TASK-SETTINGS-175H` 是唯一 Ready 游戏 task；175G 已将设置 148 闭合为 19 对象/23 状态 verified 真值，下一步只迁移任务 85 页面族的旧审计。

## 待完成任务

| Task | 状态 | 功能条线 | 类型 | 目标 | 目标机制/切片 | 输出 | 下一步 | 定义 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TASK-SETTINGS-175H | Ready | LINE-CORE-PROGRESSION-COMPLETION | 任务页真值迁移 | 将 85 页面族旧审计机械升级为当前 manifest | M-046、M-052、VS-059 | `task-settings-175h.task-page` verified manifest | TASK-SETTINGS-175I | [定义](task-definitions/TASK-SETTINGS-175H.md) |
