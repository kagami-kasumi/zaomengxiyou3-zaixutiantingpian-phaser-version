...
`TASK-SETTINGS-175I` 是唯一 Ready 游戏 task；175H 已将任务 85 闭合为 45 对象/28 状态 verified 真值，下一步只迁移建档/选角 1149/901 的旧审计。

## 待完成任务

| Task | 状态 | 功能条线 | 类型 | 目标 | 目标机制/切片 | 输出 | 下一步 | 定义 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TASK-SETTINGS-175I | Ready | LINE-CORE-PROGRESSION-COMPLETION | 建档/选角真值迁移 | 将 1149/901 旧审计机械升级为当前 manifest | M-005、M-006、M-050、M-052、VS-052 | `task-settings-175i.party-creation` verified manifest | 依据逐页 manifest 生成同线实现任务 | [定义](task-definitions/TASK-SETTINGS-175I.md) |
