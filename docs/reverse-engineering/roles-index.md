...
| Role2 | `myhc` | `* 1.2 * 35173 / 25958` | `hit6` | 直接攻击动作 |
| Role2 | `jgz` | `* 0.6 * 35173 / 25958` | `hit7` | 直接攻击动作 |
| Role2 | `tjgl` | `* 1.0 * 35173 / 25958` | `hit8` | 直接攻击动作 |
| Role2 | `jhsj` | `* 1.1 * 35173 / 25958` | `hit9` | 直接攻击动作 |
| Role2 | `xbz` | `* 0.65 * 35173 / 25958` | `hit3` | 直接攻击动作 |
| Role2 | `shy` | `* 0.55 * 35173 / 25958` | 调 `doHit10()` | 依赖 `role2Shalldow` 扣 MP |
...
- `showSkill()` 支持 `sgq/myhc/jgz/tjgl/jhsj/xbz/shy/smb`；`blb` 函数为空，`sjt` 未见分支。
- 后续重点：`hit1`、`sgq -> hit5` 的具体伤害帧/远近程表现。
