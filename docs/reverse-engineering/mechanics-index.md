...
| M-016 | UI 快捷键 | 已扒 | 部分复现 | `stage-feature-entry-index.md`、`skills-input-index.md`、`pets-index.md`、`KeyBoardControl.as`、`GameInfo.as`、`RoleInfo.as`、`magic-weapons-index.md` | `StageFeatureEntryRouterSystem.ts`、`FormalFeatureUiEntryBridge.ts`、`Stage1CombatHudBridge.ts`、现有功能 systems | 574 五真 HUD pointer、P2 镜像、P1 `C/V/B/N/Esc`、P2 `/ * -`、P2 技能默认 P1、共享门禁与 settings pending 已接入；P2 无法宝/设置快捷键保持原版边界。371/444、单页同键关闭和移除通用跨页 host 由 156B 完成，五关校准由 156C 完成 |
...
| M-052 | 完整功能 UI | 已扒 | 部分复现 | `full-function-ui-index.md`、`stage-feature-entry-index.md`、`equipment-workshop-index.md`、`skills-input-index.md`、`skill-ui-native-index.md`、`inventory-resource-catalog.md`、`equipment-index.md`、`pets-index.md`、`magic-weapons-index.md` 与完整 UI 资源标注 | `StageFeatureEntryRouterSystem.ts`、`FormalFeatureUiEntryBridge.ts`、共享 `FeatureUiHost`、V6 与正式功能页 systems/views | 页面业务与资源合同已闭合；574 五真 pointer/P2 镜像/共享 router/门禁已接入。现代仍缺 371/444，并存在原版没有的可见通用 host 与跨页/Escape 语义，须由 156B/C 完成后才能升级为关卡入口复现 |
