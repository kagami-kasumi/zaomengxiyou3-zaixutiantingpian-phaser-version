...
| M-035 | 资源加载策略 | 已扒 | 已复现 | `README_extract.md`、`evb-extraction-report.md`、`modern-architecture.md`、`assets-index.md`、`projectiles-index.md`、`levels-index.md`、`level-result-ui-index.md`、`stage1-monster-visuals-index.md`、`stage21-monster-visuals-index.md`、`equipment-visual-resource-catalog.md`、资源标注批次、`PG-009` | `AssetManifest.ts` provenance、`SceneAssetBundles.ts` 唯一 owner、`AssetBundleCoordinator.ts`、`SceneAssetBundleBridge.ts`、场景路由与负向门禁 | Boot 仅加载 shell；地图、功能 UI 和 Stage 1/2 按 bundle ensure；170B2 已冻结 164 图标、138 条穿戴预览资源和 111 个唯一 character 的跨包 provenance，现代 bundle 接入由 170C 负责。不含纹理淘汰或图片转码 |
| M-036 | 装备 | 已扒 | 部分复现 | `equipment-index.md`、`equipment-data-catalog.md`、`reference/equipment-data-catalog-1.1.json`、`equipment-visual-resource-catalog.md`、`reference/equipment-visual-resource-catalog-1.1.json`、`evidence/TASK-SETTINGS-170B1-equipment-page.md`、`task-settings-170b1-equipment-page.json`、`equipment-workshop-index.md`、`workshop-rules-completeness-audit.md`、`magic-weapons-index.md` 与 1.1 装备/背包/角色消费者 | `EquipmentSystem.ts`、`EquipmentStrengtheningSystem.ts`、`EquipmentResolutionSystem.ts`、`EquipmentMakingSystem.ts`、正式背包/工坊/法宝页面 | 170A 已冻结 164 件数据全集；170B1 已冻结 63 对象/9 状态页面真值；170B2 已闭合 164 图标与适用穿戴/称号 provenance、Role4/Role5/520/521 和原缺陷，接入未知为零。170C 负责唯一现代目录与正式页面接入，打造百分数单位留到事务收口 |
