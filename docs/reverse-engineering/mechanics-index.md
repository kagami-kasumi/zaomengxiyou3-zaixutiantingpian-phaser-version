...
| M-036 | 装备 | 已扒 | 部分复现 | `equipment-index.md`、`equipment-data-catalog.md`、`reference/equipment-data-catalog-1.1.json`、`equipment-visual-resource-catalog.md`、`reference/equipment-visual-resource-catalog-1.1.json`、`evidence/TASK-SETTINGS-170B1-equipment-page.md`、`task-settings-170b1-equipment-page.json`、`equipment-workshop-index.md`、`workshop-rules-completeness-audit.md`、`magic-weapons-index.md` 与 1.1 装备/背包/角色消费者 | `EquipmentCatalog.ts`、`EquipmentPreviewSystem.ts`、`EquipmentPageTruthSystem.ts`、`EquipmentPageQaFixtureSystem.ts`、`EquipmentSystem.ts`、正式背包/工坊/法宝页面 | 170C/170D 已闭合 164 件目录、111 character 与 63 对象/9 状态页面；171/171A 又完成 164 件强化/分解、121 Fusion、78 打造、百分数点/V6 和双 owner 联合重放。全局仍部分复现仅因成长/存档等本线后续范围 |
...
| M-044 | 存档 | 已扒 | 部分复现 | `save-slots-index.md`、`save-party-flow-index.md`、`skills-input-index.md`、`pets-index.md`、`levels-index.md`、`level-result-ui-index.md`、`inventory-resource-catalog.md`、`User.getSaveObj()`、`MemoryClass.setStorage()`、`MainGame.levelClear()`、`GameWin.nextClick()` | `SaveSystem.ts` V6、`PartyConfigurationSystem.ts`、`SaveSlotSystem.ts`、`FormalPartyRuntimeSystem.ts`、`PlayerSoulSystem.ts`、`LevelResultView.ts`、`pre-stage23-save-journey-tests.ts`、专项测试 | V5 party、原子建槽、关卡解锁和既有 V6 主旅程保持；复评确认五比例字段迁移、打造继承属性与非整数 soul 的三处持久化缺口，171B 前插 V7 修复；更广泛成长字段仍由当前功能线后续处理 |
