...
| M-044 | 存档 | 已扒 | 部分复现 | `save-slots-index.md`、`save-party-flow-index.md`、`skills-input-index.md`、`pets-index.md`、`levels-index.md`、`User.getSaveObj()`、`MemoryClass.setStorage()`、`MainGame.levelClear()`、`GameWin.nextClick()` | `SaveSystem.ts` V5、`PartyConfigurationSystem.ts`、`SaveSlotSystem.ts`、Stage 1/2-1/2-2 result bridges、专项测试 | V5 party、V1..V4/旧单槽迁移、原子建槽与 1P/2P 原生新建流程已闭合；正式消费者统一读取 party 仍由 `TASK-SLICE-152/153` 收敛 |
