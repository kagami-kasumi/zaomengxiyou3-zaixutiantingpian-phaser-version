...
| M-035 | 资源加载策略 | 已扒 | 部分复现 | `README_extract.md`、`evb-extraction-report.md`、`modern-architecture.md`、`attack-effects-index.md`、`assets-index.md`、`projectiles-index.md`、`combat-assets-gap-plan.md`、`crafting-ui-index.md`、`equipment-workshop-index.md`、`levels-index.md` | `src/assets/AssetManifest.ts` 的状态化 manifest、Role1 普攻真资源、炼丹炉 UI/图标真资源、Stage 1-1/1-2/1-3 真场景资源和项目外已恢复源 SWF | character 119 已派生无按钮 940×590 背景，DefineButton2 95/99/109/113 的 12 个 up/over/down SVG 已以独立 child 组合；来源 id、位置、状态和生成脚本均可追溯，未扩张无关资源 |
...
| M-052 | 完整功能 UI | 部分已扒 | 部分复现 | `full-function-ui-index.md`、`equipment-workshop-index.md`、`skills-input-index.md`、`equipment-index.md`、`pets-index.md`、`magic-weapons-index.md` 与 11 条完整 UI 资源标注 | 共享 `FeatureUiHost`、V4、正式背包、技能、宠物、工坊四事务与法宝页面 systems/views | 工坊已按 PG-007 原生化；技能总页/主动/绑定/被动仍存在现代外层 UI，已登记 `LINE-UI-NATIVE-SKILLS` / `TASK-SETTINGS-061` / `TASK-SLICE-143`。宠物、法宝等存量页面继续由 PG-007 追踪，不以“真背景已接入”宣告 UI 原生化完成 |
