...
| M-041 | 技能学习/绑定 | 已扒 | 已复现 | `skills-input-index.md`、`User.skillbykey`、`SkillControl.as`、`SkillSetControl.as`、`BuySkill.as`、`PassiveSkillControl.as` | `SkillUISystem.ts`、`FormalSkillPageSystem.ts`、`FormalSkillPageView.ts`、`FormalSkillRuntimeBridge.ts` | 技能规则、五角色两心法、真 UI、P1/P2 五槽、HUD 与 V5 字段已完成；入口/selector/事务/保存统一消费活动 owner/hero，主动/被动动态字段不再重复 |
...
| M-052 | 完整功能 UI | 部分已扒 | 部分复现 | `full-function-ui-index.md`、`equipment-workshop-index.md`、`skills-input-index.md`、`skill-ui-native-index.md`、`equipment-index.md`、`pets-index.md`、`magic-weapons-index.md` 与 11 条完整 UI 资源标注 | 共享 `FeatureUiHost`、V5、正式背包、技能、宠物、工坊四事务与法宝页面 systems/views | 技能 250/868/417/213 已按 PG-007/009 完成静态/动态 child 分离、五角色心法、P1/P2、灵魂存档与页/角色级加载；证据见 `TASK-SLICE-154-visual-audit.md`。其他存量页面继续由 PG-007 追踪 |
