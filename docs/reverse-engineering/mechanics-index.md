...
| M-052 | 完整功能 UI | 已扒 | 已复现 | `full-function-ui-index.md`、`stage-feature-entry-index.md`、`level-result-ui-index.md`、`equipment-workshop-index.md`、`skills-input-index.md`、`skill-ui-native-index.md`、`inventory-resource-catalog.md`、`equipment-index.md`、`pets-index.md`、`magic-weapons-index.md` 与完整 UI 资源标注 | `StageFeatureEntryRouterSystem.ts`、`StageSettingsSystem.ts`、`FormalFeatureUiEntryBridge.ts`、`StageSettingsScene.ts`、`LevelResultView.ts`、V6 与正式功能页 systems/views | 165A 闭合关卡五入口；166D 闭合正式背包；165D 闭合炼丹炉 119 右栏原生背包格、四业务页、双 owner、分页/暂存/返还与 940×590 零 console，前置完整功能 UI 缺口清零 |
