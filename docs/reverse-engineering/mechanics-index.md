...
| M-036 | 装备 | 已扒 | 已复现 | `equipment-index.md`、`equipment-workshop-index.md`、`magic-weapons-index.md`、`my/AllEquipment.as`、`my/MyEquipObj.as`、`export/pack/BackPack.as`、`export/strength/Strength/Resolution/Making/SutraInterface.as`、`base/BaseRoleProperies.as` | `EquipmentSystem.ts`、`EquipmentStrengtheningSystem.ts`、`EquipmentResolutionSystem.ts`、`EquipmentMakingSystem.ts`、正式背包/工坊页面 | 真背包页支持 P1/P2 六槽穿脱、角色限制、属性预览和 V4；真强化/分解/制作页已闭合实例成长、随机事务、78 本可达制作书、三宝石实例覆写和双 owner 保存，五行重置与完整 1.1 装备基础数值表仍按后续任务闭合 |
...
| M-052 | 完整功能 UI | 部分已扒 | 部分复现 | `full-function-ui-index.md`、`equipment-workshop-index.md`、`skills-input-index.md`、`equipment-index.md`、`pets-index.md`、`magic-weapons-index.md` 与 11 条完整 UI 资源标注 | 共享 `FeatureUiHost`、V4、正式背包、技能、宠物、工坊/Fusion/强化/分解/制作页面 systems/views | 共享 host、双玩家 V4、真背包/装备、技能四页、宠物页与工坊四事务已完成；当前推进 `GOAL-005` / `TASK-SLICE-139` 真法宝页，端到端旅程仍后置 |
