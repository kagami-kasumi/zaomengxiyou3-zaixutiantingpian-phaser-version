...
| M-035 | 资源加载策略 | 已扒 | 部分复现 | `README_extract.md`、`evb-extraction-report.md`、`modern-architecture.md`、`attack-effects-index.md`、`assets-index.md`、`projectiles-index.md`、`combat-assets-gap-plan.md`、`crafting-ui-index.md` | `src/assets/AssetManifest.ts` 的状态化 manifest、Role1 普攻真资源、炼丹炉 UI 真资源和项目外已恢复源 SWF | 已完成 Role1 普攻、炼丹炉完整 UI 及土灵珠/枯叶灵两个真图标配方族；下一步转向 Stage 1-1 源符号定位 |
