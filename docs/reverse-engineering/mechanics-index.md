...
| M-048 | 战斗可读性与通关校准 | 已扒 | 部分复现 | `stage1-combat-calibration.md`、`combat-rules-index.md`、`progression-index.md`、`attack-effects-index.md`、Stage 1 怪物/角色 AS3、恢复语料窄查、用户 2026-07-21 试玩反馈 | 1-1 共享 combat；1-2/1-3 私有心数/接触伤害 bridge；Role1 真普攻资源 | 已确认三关模型分裂与 1-2 多 source 同帧爆发；`TASK-SLICE-130` 统一 owner、攻击窗口和死亡记录后按 1-1 2/3 通关及 1-2/1-3 观察指标校准；怪物精确 SWF 几何仍明确未知 |
