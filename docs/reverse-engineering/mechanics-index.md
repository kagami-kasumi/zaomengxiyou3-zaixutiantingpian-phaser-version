...
| M-052 | 完整功能 UI | 部分已扒 | 部分复现 | `full-function-ui-index.md`、`equipment-workshop-index.md`、`skills-input-index.md`、`skill-ui-native-index.md`、`inventory-resource-catalog.md`、`equipment-index.md`、`pets-index.md`、`magic-weapons-index.md` 与完整 UI 资源标注 | 共享 `FeatureUiHost`、V6、正式背包、技能、宠物、工坊四事务与法宝页面 systems/views | 背包 304/246/628 与 22 个原生控件已按 PG-007/009 完成静态/动态 child 分离、四分类分页、428 真图标和 P1/P2/V6，证据见 `TASK-SLICE-160-visual-audit.md`；技能/工坊灵魂余额等既有页面继续共享动态组件。其他存量页面继续由 PG-007 追踪 |
