...
| M-037 | 背包 | 部分已扒 | 部分复现 | `equipment-index.md`、`user/User.as`、`export/pack/BackPackElement.as`、`export/pack/PackThings.as`、`config/Config.as` | `InventorySystem.ts`、`FormalInventoryPageSystem.ts`、`FeatureUiScene.ts` | 真 940×590 页已闭合四分类、每页 25 格、P1/P2 owner、安全反馈与 V4/V6 当前槽持久化；用户已将完整 1.1 可入包物品表与真图标提升为丹药前置，现由 `TASK-SETTINGS-070 / TASK-SLICE-160 / VS-064` 闭合，不能再以既有页面切片代表全量资源完成 |
