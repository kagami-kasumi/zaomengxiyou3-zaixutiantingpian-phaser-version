...
| M-036 | 装备 | 已扒 | 部分复现 | `equipment-index.md`、`equipment-workshop-index.md`、`workshop-rules-completeness-audit.md`、`evidence/TASK-SETTINGS-167-workshop-left-pages.md`、四份 `task-settings-167-workshop-*.json`、`magic-weapons-index.md`、`my/AllEquipment.as`、`my/MyEquipObj.as`、`export/pack/BackPack.as`、`export/strength/Strength/Resolution/Making/SutraInterface.as`、`base/BaseRoleProperies.as` | `EquipmentSystem.ts`、`EquipmentStrengtheningSystem.ts`、`EquipmentResolutionSystem.ts`、`EquipmentMakingSystem.ts`、正式背包/工坊/法宝页面 | 169 已冻结强化/分解/打造的规则、现代映射与缺口；完整 1.1 的 164 件可穿戴基础值、强化成长和逐项 UI 回放仍待 170A 起的同线任务闭合，打造百分数单位差异留到事务收口 |
