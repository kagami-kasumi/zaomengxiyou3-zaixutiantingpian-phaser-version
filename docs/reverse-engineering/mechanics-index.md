...
| M-020 | Role3 八戒 | 已扒 | 已复现 | `roles-index.md`、`skills-input-index.md`、`projectiles-index.md`、`role3-combat-visuals-index.md`、`Role3.as`、`BaseAddEffect.as`、`BaseBitmapDataClip.as` | `Role3DefenseSkillSystem.ts`、`Role3ControlSkillSystem.ts`、`Role3ImpactSkillSystem.ts`、`Role3MobilitySkillSystem.ts`、`Role3UltimateSkillSystem.ts`、`TestSceneRole3SkillBridge.ts` | 九项主动、`rj` 被动与协同行为已复现；069C 已闭合13本体/9装备、三普攻、盾/拉拽/追踪对象和 HUD 的真视觉输入，接入仍待158C |
...
| M-047 | 角色普攻特效资源 | 已扒 | 部分复现 | `attack-effects-index.md`、`assets-index.md`、`combat-assets-gap-plan.md`、`evb-extraction-report.md`、`hero-combat-visuals-index.md`、`role1-combat-visuals-index.md`、`role2-combat-visuals-index.md`、`role3-combat-visuals-index.md`、`Role*.normalHit()`、`Role*.doHit*()`、`BaseBitmapDataPool.as` | Role1/Role2 真资源序列、对应 CombatVisualBridge、`HeroNormalAttackSystem.ts` | Role1/Role2 已接入；Role3 三普攻 29 帧、注册 bounds、生成 tick/点与本体 cell 已闭合并待158C接入，Role4..5仍待逐角色闭合 |
