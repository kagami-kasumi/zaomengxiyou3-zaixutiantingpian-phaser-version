...
| M-026 | 关卡类命名 | 已扒 | 未复现 | `levels-index.md`、`gameplay-index.md`、`MainGame.newGame()`、`PhysicsWorld.pWorldInit()`、RegiMA `assets/levels/level11.swf` 与 `assets/1.swf` | 无 | `sl11` 已定位为 level11 character 46；`bg11/floorBg1` 已定位为 Stage 1 公共包 character 141/1；待选择性派生并替换 VS-007 手工场景参数 |
...
| M-035 | 资源加载策略 | 已扒 | 部分复现 | `README_extract.md`、`evb-extraction-report.md`、`modern-architecture.md`、`attack-effects-index.md`、`assets-index.md`、`projectiles-index.md`、`combat-assets-gap-plan.md`、`crafting-ui-index.md`、`levels-index.md` | `src/assets/AssetManifest.ts` 的状态化 manifest、Role1 普攻真资源、炼丹炉 UI 真资源和项目外已恢复源 SWF | Stage 1-1 的布局/背景/地面已闭合到 character 46/141/1；下一步按精确符号选择性派生并接入真场景资源 |
