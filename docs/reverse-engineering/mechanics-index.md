...
| M-024 | 角色组合键 | 已扒 | 部分复现 | `roles-index.md`、`skills-input-index.md`、`Role*.myKeyDown()`、`controls-index.md` | `Role1BasicSkillSystem.ts`、`Role2PassiveSkillSystem.ts`、`Role3ImpactSkillSystem.ts`、`HeroNormalAttackSystem.ts` | Role1 普攻+上 `slz`、跑动普攻 `hytj`、Role2 持续普攻蓄力与 Role3 普攻+上 `hit8` 已复现；Role4/5 继续推进 |
| M-025 | 角色技能效果 | 已扒 | 部分复现 | `skills-input-index.md`、`roles-index.md`、`projectiles-index.md`、`Role*.showSkill()`、`Config.allSklName` | `HeroSkillSystem.ts`、`Role1BasicSkillSystem.ts`、`Role1ShadowSkillSystem.ts`、`Role1FinisherSkillSystem.ts`、`Role2*SkillSystem.ts`、`Role3*SkillSystem.ts`、`Role4*SkillSystem.ts`、`ProjectileSystem.ts`、角色场景桥接 | Role1、Role2、Role3 和 Role4 完整技能已复现；M-025 保持部分复现因 Role5 尚未完成 |
...
| M-034 | 子弹/技能飞行物 | 部分已扒 | 部分复现 | `projectiles-index.md`、`BaseBullet.as`、`export/bullet/`、`Role1.as` 至 `Role5.as`、`Role1Shadow.as`、`MagicPearl.as`、`MagicZLHummer.as`、`Ling.as`、`MagicBigBottle.as` | `ProjectileSystem.ts`、`Role1BasicSkillSystem.ts`、`Role1SkillProjectileFactory.ts`、`Role1ShadowSkillSystem.ts`、`Role1FinisherSkillSystem.ts`、`Role2*SkillSystem.ts`、`Role3*SkillSystem.ts`、`Role4*SkillSystem.ts`、`TestScene.ts`、`AssetManifest.ts` | Role1、Role2、Role3、Role4 projectile 行为已随完整战斗切片复现；Role1 `Role1Bullet6/7/8_1/8_2/9/10_2/10_4_tmp/11_1/11_2/12/12_1_1/12_1_2/13/14_1/14_2` 与 `ROLE1_SHALLDOW` 占位已接入，Role5 仍待逆向 |
