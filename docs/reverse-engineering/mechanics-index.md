...
| M-036 | 装备 | 已扒 | 部分复现 | `equipment-index.md`、`equipment-workshop-index.md`、`evidence/TASK-SETTINGS-167-workshop-left-pages.md`、四份 `task-settings-167-workshop-*.json`、`magic-weapons-index.md`、`my/AllEquipment.as`、`my/MyEquipObj.as`、`export/pack/BackPack.as`、`export/strength/Strength/Resolution/Making/SutraInterface.as`、`base/BaseRoleProperies.as` | `EquipmentSystem.ts`、`EquipmentStrengtheningSystem.ts`、`EquipmentResolutionSystem.ts`、`EquipmentMakingSystem.ts`、正式背包/工坊/法宝页面 | 168A/168B 已原生化强化、合成、分解、打造的动态 child、原字段、按钮态与全局反馈；169 审计四功能规则。完整 1.1 可穿戴全集、基础数值和逐项 UI 回放仍待本线后续闭合 |
