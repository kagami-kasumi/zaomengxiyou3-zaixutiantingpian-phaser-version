...
| M-037 | 背包 | 已扒 | 部分复现 | `inventory-resource-catalog.md`、`reference/inventory-resource-catalog-1.1.json`、`evidence/TASK-SETTINGS-165B-backpack-review.md`、`equipment-index.md`、`user/User.as`、`export/pack/BackPackElement.as`、`export/pack/PackThings.as`、`config/Config.as` | `InventoryResourceCatalog.ts`、`InventorySystem.ts`、`FormalInventoryPageSystem.ts`、`InventoryGridProjection.ts`、`FormalInventoryPageView.ts` | 431 身份、428 真图标、3 原版缺陷排除、事务、P1/P2 与 V6 保持；166B 已闭合 304 动态角色/字段/六槽、50×51/61×60 的 25 格、358/610 操作层及战斗即时/地图回退。炼丹炉嵌入式背包仍待 165D，因此保持部分复现 |
...
| M-052 | 完整功能 UI | 已扒 | 部分复现 | `full-function-ui-index.md`、`stage-feature-entry-index.md`、`level-result-ui-index.md`、`equipment-workshop-index.md`、`skills-input-index.md`、`skill-ui-native-index.md`、`inventory-resource-catalog.md`、`equipment-index.md`、`pets-index.md`、`magic-weapons-index.md` 与完整 UI 资源标注 | `StageFeatureEntryRouterSystem.ts`、`StageSettingsSystem.ts`、`FormalFeatureUiEntryBridge.ts`、`StageSettingsScene.ts`、`LevelResultView.ts`、V6 与正式功能页 systems/views | 165A 已重新闭合关卡五入口；166B 已闭合正式背包动态层、双 owner 与逐状态证据。炼丹炉嵌入式背包仍待 165D，因此 M-052 保持部分复现 |
