...
总计 1246 条标注：1043 条 `ready`、25 条 `derived-ready`、160 条 `export-ready`、10 条 `source-corpus-ready`、2 条 `missing-original`、6 条 `rejected`；1246 条均为 `confirmed`。当前没有 `needs-annotation`、`needs-splitting` 或 `unknown` 条目。
