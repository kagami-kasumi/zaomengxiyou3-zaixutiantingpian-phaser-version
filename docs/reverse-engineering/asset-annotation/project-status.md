...
总计 966 条标注：778 条 `ready`、35 条 `derived-ready`、1 条 `export-ready`、145 条 `source-corpus-ready`、1 条 `missing-original`、1 条 `needs-annotation`、5 条 `rejected`；965 条 `confirmed`、1 条 `unknown`。当前没有 `needs-splitting` 条目。
