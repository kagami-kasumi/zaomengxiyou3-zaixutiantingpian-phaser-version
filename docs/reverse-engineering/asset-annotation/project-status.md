...
第一批标注范围已完成语义调查，并已迁移到 EVB 恢复后的分阶段台账。Role1 四组普攻附属对象、炼丹炉完整 UI、201/201 个权威合成图标以及 Stage 1-1/1-2/1-3 真场景视觉资源已完成接入；Stage 2-1 的真场景与冰刺已接入，四怪本体和七个攻击对象已完成选择性派生与实现输入标注。
