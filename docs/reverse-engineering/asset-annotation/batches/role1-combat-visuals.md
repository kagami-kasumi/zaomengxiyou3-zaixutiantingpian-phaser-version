...
- 推测：0。
- 影响实现的未知：0。
- 现代状态：本体、装备、影分身、四组普攻对象与全部已实现技能对象均为 `ready`，下一动作 `none`。
...
- [x] 158A 已把 3 张角色 atlas 与 249 帧技能序列接入唯一 `combat-common` owner，并通过专项/全门禁与 940×590 运行验收。
