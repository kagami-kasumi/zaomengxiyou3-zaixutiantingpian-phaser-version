...
- `public/assets/stages/stage-2-2/` 的 `scene/objects/hazards` 子树接入背景、中景、前景、普通门与 FireThron 130 个真 SVG 帧；`floorBg2` 复用 `public/assets/stages/shared/floors/` 的地板资源 owner。
...
- `public/assets/monsters/monster-16/` 接入 1800×2400 本体 atlas、六攻击对象 104 个真 SVG 帧与注册点几何 CSV。
