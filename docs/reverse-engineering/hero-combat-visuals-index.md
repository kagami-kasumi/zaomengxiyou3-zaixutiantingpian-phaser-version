...
| Role5 白龙 | `assets/bailong.swf`、`assets/bailongSword.swf` | 069E 已闭合：25张2800×5950本体/装备表、双形态动作与1572帧选择性对象/HUD证据；仅 `Role5runattack` 为全集反证 | [Role5战斗视觉索引](role5-combat-visuals-index.md)；158E负责现代接入 |
