...
- `local-resources/regima/legacy-extraction/resources_by_swf/[172845].swf/scripts/export/pack/BackPackElement.as`
...
- `User.as` 实际路径是 `local-resources/regima/legacy-extraction/resources_by_swf/[172845].swf/scripts/user/User.as`，不是看板中旧写法 `my/User.as`。
