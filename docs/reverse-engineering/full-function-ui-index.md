...
| FUI-02 | 背包/角色总览 | P1 C、P2 num `/`；再次按或关闭按钮退出 | 角色名/等级/经验/战力/HP/MP/属性、6 装备槽、时装显示、出售白装 | `BackPack.setpack(1/2)` 绑定对应 hero/User | 装备、分类背包、时装显示、角色成长 | 304 | 入口、静态根、P1/P2 数据/穿脱/V6 继续成立；165B 证明角色、等级、属性、经验和六槽等动态 child 未完成 | `TASK-SLICE-165C` 按 165B 完整显示列表整改；不得保留现代右栏文字替代 |
| FUI-03 | 背包分类与物品详情 | FUI-02 内嵌 | 装备/道具/时装/技能书；5 页×25 格；选择、预览、穿脱、使用/丢弃/给予门禁 | 跟随 FUI-02 owner | `zblist/djlist/szlist/jnslist/curarray` | 246、628、358、610；428 真图标 | 四分类/库存事务已完成，但当前格距 `43×41` 而非原版 `61×60`，并缺 358/610 原生操作弹层 | `TASK-SLICE-165C` 修正格距、选择/弹层/disabled 状态；专属物品效果仍显式后置 |
