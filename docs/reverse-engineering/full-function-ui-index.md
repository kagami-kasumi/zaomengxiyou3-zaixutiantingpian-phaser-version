...
| FUI-04 | 技能总页 | P1 V、P2 num `*`、地图 `showBuySkill`；返回原场景 | 角色选择、主动/被动切换、灵魂显示 | 原版页可选 P1/P2；战斗快捷键默认打开对应 owner | 技能树、绑定、被动、灵魂 | 250；`task-settings-175d.skill-pages` verified | 250 对象/32 状态真值已闭合；正式 view 已直接消费 manifest，现代覆盖与手写视觉源已删除 | `TASK-SLICE-183` 已完成；保持 manifest 直连与逐状态门禁 |
| FUI-05 | 主动心法/技能学习 | FUI-04 主动标签 | 两棵心法、树升级、5×2 技能、学习上限、技能升级/预览 | 当前选中 User | `isstudyskill` 等价结构 | 868/865；manifest 覆盖十树与 50 图标×3 帧 | 十树、按钮、字段与动态 `LV.n` 已直接投影 | `TASK-SLICE-183` 已完成 |
| FUI-06 | 五槽技能绑定 | FUI-05 技能设置按钮；关闭提交返回 | source、五槽、拖放/替换、P1/P2 键位映射 | 当前选中 User | `skillbykey` 等价结构 | 417；manifest 覆盖 P1/P2、拖放/回退/提交 | 原槽、P1/P2 键位与提交返回已直接投影 | `TASK-SLICE-183` 已完成 |
| FUI-07 | 被动技能 | FUI-04 被动标签 | 5 个被动等级与说明 | 当前选中 User | `ispassiveskill` | 213/212；manifest 覆盖五行、字段、207 和满级隐藏 | 五行显示列表与动态字段已直接投影 | `TASK-SLICE-183` 已完成 |
