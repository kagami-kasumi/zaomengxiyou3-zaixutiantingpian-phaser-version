...
export function getPetTurtleNoncriticalPower(context: PetBehaviorContext, action: 'hit1' | 'hit2'): number {
  const pet = context.pet;
  const base = action === 'hit1' ? pet.atk : pet.atk * 1.05;
...
export function refreshPetTurtleDamage(context: PetBehaviorContext, action: 'hit1' | 'hit2') {
