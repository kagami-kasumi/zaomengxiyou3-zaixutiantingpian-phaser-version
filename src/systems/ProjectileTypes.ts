...
export type ProjectileVariant =
  ...
  | 'role5-tlj-hit11'
  | 'role5-pkz-hit24-1'
  | 'role5-pkz-hit24-1-enhanced'
  | 'role5-pkz-hit24-2'
  | 'role5-pkz-hit24-3'
  | 'role5-lxj-hit26'
  | 'role5-mlsz-hit29-1'
  | 'role5-mlsz-hit29-1-enhanced'
  | 'role5-mlsz-hit29-2'
  | 'role5-mlsz-hit29-2-enhanced'
  | 'role5-mlsz-hit29-3'
  | 'role5-mlsz-hit29-3-enhanced'
  | 'role5-mlsz-hit29-4'
  | 'role5-mlsz-hit29-4-enhanced'
  | 'role5-mlsz-hit29-5'
  | 'role5-mlsz-hit29-5-enhanced'
  | 'role5-lysh-companion'
  | 'role5-lysh-shot'
