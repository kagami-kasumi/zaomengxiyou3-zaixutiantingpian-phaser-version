...
export function createSeedEquipmentRegistry(): Record<string, EquipmentDefinition> {
  const definitions: EquipmentDefinition[] = [
    ...
    },
    {
      ...
      color: '0xFFFFFF',
      stats: createEmptyEquipmentStats(),
      description: '强化石道具，可在装备工坊提高强化成功率',
    },
    {
      showId: 1,
      name: '幸运符',
    ...
    },
    {
      ...
      color: '0xFFFFFF',
      stats: createEmptyEquipmentStats(),
      description: '当前出战宠物还童至一阶一级并重置成长属性',
    },
    {
      showId: 131,
      name: '潜力丹（原版残留）',
      ...
      color: '0xFFFFFF',
      stats: createEmptyEquipmentStats(),
      description: '当前原版构建缺少潜力字段和公式，不会消耗',
    },
    {
      showId: 132,
      name: '宠物进化丹',
      ...
      color: '0xFFFFFF',
      stats: createEmptyEquipmentStats(),
      description: '让三阶宠物进化至四阶；其他形态遵循原版消耗边界',
    },
    {
      showId: 1,
      name: '枯叶灵',
