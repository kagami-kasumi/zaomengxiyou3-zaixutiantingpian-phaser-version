...
def main():
    probe=ROOT/'tools/horse-spatial/CallbackProbe.as'
...
<id>regima.task229.callbacks</id><versionNumber>1.0.0</versionNumber><filename>CallbackProbe</filename>
...
<width>940</width><height>590</height><systemChrome>none</systemChrome><renderMode>direct</renderMode></initialWindow></application>''',encoding='utf-8')
    ...
    print('229 callback cases:',len(cases))
