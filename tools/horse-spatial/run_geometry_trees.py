...
def main():
    ...
    builder=BASE/'geometry-air/GeometryProbe.as'
...
trace("COMPLETE");NativeApplication.nativeApplication.exit(0);}
    ...
    print('229 reconstructed complete trees:',len(trees))
