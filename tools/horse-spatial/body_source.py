...
WORK = ROOT/'local-resources/regima/task-outputs/TASK-SETTINGS-229/body-air'
...
def main():
    ...
    for i, (owner,cid) in enumerate([('20120203',17),('20120203',15),('20120203',12),('pet1',19)]):
    ...
    print('229 native atlas observation fixture:',[(s['form'],s['width'],s['height']) for s in specs])
