...
WORK = ROOT/'local-resources/regima/task-outputs/TASK-SETTINGS-228/natural-collision-air'
...
<id>regima.task228.naturalcollision</id><versionNumber>1.0.0</versionNumber><filename>NaturalCollisionProbe</filename>
...
<width>940</width><height>590</height><systemChrome>none</systemChrome><renderMode>direct</renderMode></initialWindow></application>''',encoding='utf-8')
    ...
    print('228 natural collision cases:',len(cases),'; hits:',sum(c['hit'] for c in cases))
