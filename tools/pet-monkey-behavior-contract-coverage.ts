...
export const monkeyBehaviorContractCoverage: readonly BehaviorContractCoverage[] = [
  ...
  trace('monkey1.normal', ['/forms/0/attackRange', '/forms/0/actions/normal'], ['monkey1-p1-range-chain', 'monkey1-p2-range-chain'], ['distance', 'action', 'actionToken', 'projectileId', 'projectileActionToken', 'attackId'], ['normal attack starts in range and reaches its frozen hit frame']),
  ...
  trace('monkey2.normal', ['/forms/1/attackRange', '/forms/1/actions/normal'], ['monkey2-p1-range-chain', 'monkey2-p2-range-chain'], ['distance', 'action', 'actionToken', 'projectileId', 'projectileActionToken', 'attackId'], ['normal attack starts in range and reaches its frozen hit frame']),
  ...
  trace('monkey3.normal', ['/forms/2/attackRange', '/forms/2/actions/normal'], ['monkey3-p1-range-chain', 'monkey3-p2-range-chain'], ['distance', 'action', 'actionToken', 'projectileId', 'projectileActionToken', 'attackId'], ['normal attack starts in range and reaches its frozen hit frame']),
  ...
  trace('monkey4.normal', ['/forms/3/attackRange', '/forms/3/actions/normal'], ['monkey4-p1-range-chain', 'monkey4-p2-range-chain'], ['distance', 'action', 'actionToken', 'projectileId', 'projectileActionToken', 'attackId'], ['normal attack starts in range and reaches its frozen hit frame']),
