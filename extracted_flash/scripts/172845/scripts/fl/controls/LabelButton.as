package fl.controls
{
   ...
   public class LabelButton extends BaseButton implements IFocusManagerComponent
   {
      ...
      override protected function drawLayout() : void
      {
         ...
         var _loc2_:String = this.icon == null && this.mode == "center" ? ButtonLabelPlacement.TOP : this._labelPlacement;
         ...
         var _loc5_:Number = this.icon == null ? 0 : this.icon.width + _loc1_;
         var _loc6_:Number = this.icon == null ? 0 : this.icon.height + _loc1_;
