package export.magicWeapon.MagicBigBottleChild
{
   ...
   public class StageBoat extends ThroughWall
   {
      ...
      public function StageBoat(param1:BaseObject, param2:int)
      {
         super();
      ...
      override public function step() : void
      {
         ...
         if(_loc2_ != 0)
         {
            TweenMax.to(this,0.1,{"y":this.y + _loc2_ + 70});
         }
