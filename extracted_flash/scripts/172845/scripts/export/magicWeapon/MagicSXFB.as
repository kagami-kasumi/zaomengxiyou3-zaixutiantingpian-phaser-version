package export.magicWeapon
{
   ...
   public class MagicSXFB extends BaseMagicWeapon
   {
      
      public function MagicSXFB(param1:BaseHero)
      {
         super(param1);
         this.bmwId = BaseMagicWeapon.BMW_SXFB;
         this.mp = 10;
      }
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("MagicSXFBBmd");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
      ...
      override public function showSkill() : void
      {
         ...
         if(this.sourceRole)
         {
            ...
            {
               timeCount = gc.frameClips * 11;
            }
            this.sourceRole.addCurAddEffect([{
               "name":BaseAddEffect.SXFB_BUFF,
               "time":timeCount
            }]);
            TweenMax.delayedCall(21,function(param1:MagicSXFB):*
            {
