package export.monster
{
   ...
   public class Monster6007 extends MonsterEntity
   {
      
      private static var _this:Monster6007;
      ...
      private var canreleaseskill4:Boolean = false;
      
      private var skill2times:int = 2;
      
      public function Monster6007()
      {
         super();
         _this = this;
         this.setHp(5800000 * 0.7);
         this.setSHp(5800000 * 0.7);
         ...
         this.skillCD4 = [gc.frameClips * 999999,gc.frameClips * 999999];
         this.skillCD5 = [gc.frameClips * 8,gc.frameClips * 10];
      ...
      public static function getInstance() : Monster6007
      {
         return _this;
      }
      ...
      override protected function initBBDC() : void
      {
         try
         {
            bbdc = AnimationManager.getAnimation("zijingpengwangfenshen");
            bbdc.setOffset(-159,-160);
            bbdc.setAction("wait");
            bbdc.turnLeft();
      ...
      {
         var _loc2_:FollowBaseObjectBullet = new FollowBaseObjectBullet("zijingpengwang_skill1_1");
         _loc2_.setRole(this);
      ...
      {
         var _loc2_:EnemyMoveBullet2 = new EnemyMoveBullet2("zijingpengwang_skill1_2");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 159 + 48 + 5;
         }
         else
         {
            _loc2_.x = this.x + 159 - 48 - 5;
         }
         _loc2_.y = this.y - 160 + 166 + 17;
         _loc2_.setDirect(this.getBBDC().getDirect());
      ...
      private function banyuezhan1_6() : void
      {
         var _loc2_:EnemyMoveBullet2 = new EnemyMoveBullet2("zijingpengwang_skill1_2");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
      ...
      private function banyuezhan1_7() : void
      {
         var _loc2_:EnemyMoveBullet2 = new EnemyMoveBullet2("zijingpengwang_skill1_2");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
      ...
      {
         var _loc2_:FollowBaseObjectBullet = new FollowBaseObjectBullet("zijingpengwang_skill2");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 159;
      ...
      {
         var _loc1_:EnemyMoveBullet = new EnemyMoveBullet("zijingpengwang_skill1_2");
         var angle:Number = (2 * Math.random() - 1) * Math.PI;
         _loc1_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc1_.x = this.x - 159 + 68 + 5 + 88;
         }
         else
         {
            _loc1_.x = this.x + 159 - 68 - 5 - 88;
         }
         _loc1_.y = this.y - 160 + 157 + 17 - 6;
         _loc1_.setDirect(this.getBBDC().getDirect());
         _loc1_.setSpeed(Math.cos(angle) * 15,Math.sin(angle) * 15);
         if(_loc1_.transform.matrix.a > 0)
         {
            _loc1_.setRotaion(-(angle * (-180 / Math.PI) + 180));
         }
         else
         {
            _loc1_.setRotaion(angle * (-180 / Math.PI));
         }
         _loc1_.setDistance(1000);
         _loc1_.setDestroyWhenLastFrame(false);
         _loc1_.setAction("hit2");
      ...
      {
         var _loc2_:FollowBaseObjectBullet = new FollowBaseObjectBullet("zijingpengwang_skill3","zijingpengwang_skill3_box");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 159;
      ...
      {
         var _loc2_:FollowBaseObjectBullet = new FollowBaseObjectBullet("zijingpengwang_skill4");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 159;
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("zijingpengwang_skill5_1","zijingpengwang_skill5_3");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 159;
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("zijingpengwang_skill5_2");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 159;
      ...
      {
         return Boolean(this.curAttackTarget) && Boolean(this.canreleaseskill3) && AUtils.GetDisBetweenTwoObj(this,this.curAttackTarget) <= 250;
      }
      ...
      {
         return this.curAction == "skill1" || this.curAction == "skill2_1" || this.curAction == "skill2_2" || this.curAction == "skill2_3" || this.curAction == "skill3" || this.curAction == "skill4" || this.curAction == "skill4_1" || this.curAction == "skill5" || this.curAction == "skill5_2" || this.curAction == "skill5_3";
      }
      
      override protected function isYCannotMoveWhenAttack() : Boolean
      {
         return this.curAction == "skill1" || this.curAction == "skill2_1" || this.curAction == "skill2_2" || this.curAction == "skill2_3" || this.curAction == "skill3" || this.curAction == "skill4" || this.curAction == "skill4_2" || this.curAction == "skill4_1" || this.curAction == "skill5" || this.curAction == "skill5_2" || this.curAction == "skill5_3";
      }
      ...
      {
         if(this.curAction == "skill1" || this.curAction == "skill2_1" || this.curAction == "skill2_2" || this.curAction == "skill2_3" || this.curAction == "skill3" || this.curAction == "skill4" || this.curAction == "skill4_2" || this.curAction == "skill4_1" || this.curAction == "skill5" || this.curAction == "skill5_2" || this.curAction == "skill5_3")
         {
            param2 = false;
         }
      ...
      {
         if(!(this.curAction == "skill1" || this.curAction == "skill2_1" || this.curAction == "skill2_2" || this.curAction == "skill2_3" || this.curAction == "skill3" || this.curAction == "skill4" || this.curAction == "skill4_2" || this.curAction == "skill4_1" || this.curAction == "skill5_1" || this.curAction == "skill5_2" || this.curAction == "skill5_3"))
         {
