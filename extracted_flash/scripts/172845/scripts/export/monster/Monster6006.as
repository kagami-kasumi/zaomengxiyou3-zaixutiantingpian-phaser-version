package export.monster
{
   ...
   public class Monster6006 extends MonsterEntity
   {
      
      private static var _this:Monster6006;
      ...
      public function Monster6006()
      {
         ...
         this.graity = 0.8;
         this.isFly = true;
         this.monsterName = "紫睛鹏王";
         this.isBoss = true;
         this.skillCD1 = [gc.frameClips * 2.5,gc.frameClips * 7];
         this.skillCD2 = [gc.frameClips * 5,gc.frameClips * 11];
         this.skillCD3 = [gc.frameClips * 6,gc.frameClips * 13];
         this.skillCD4 = [gc.frameClips * 999999,gc.frameClips * 999999];
         this.skillCD5 = [gc.frameClips * 8,gc.frameClips * 13];
      ...
      public static function getInstance() : Monster6006
      {
         return _this;
      }
      ...
      override protected function initBBDC() : void
      {
         try
         {
            bbdc = AnimationManager.getAnimation("zijingpengwang");
         ...
         switch(action)
         {
            ...
            case "skill4":
               if(frameCount == 1)
               {
                  ...
                  MainGame.getInstance().createMonster(6007,this.x,this.y);
                  this.speed.x = 0;
               }
               this.speed.y = 0;
               break;
      ...
      {
         return Boolean(this.curAttackTarget) && this.isBoss && Boolean(this.canreleaseskill3) && AUtils.GetDisBetweenTwoObj(this,this.curAttackTarget) <= 250;
      }
      ...
      override protected function myIntelligence() : void
      {
         ...
         if(!this.canreleaseskill4 && this.getHp() <= this.getSHp() * 0.5)
         {
