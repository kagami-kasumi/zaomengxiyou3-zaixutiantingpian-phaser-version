package export.monster
{
   ...
   public class Monster74 extends BaseMonster
   {
      
      public function Monster74()
      {
         super();
         this.horizenSpeed = 3;
         if(Math.random() <= 0.5)
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetTigerBmd1");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[15],[2,2,2,2],[2,2,2,10],[2,2,2,10]]);
            bbdc.setFrameCount([6,1,4,4,4]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("PetTigerBmd1--BitmapData Error!");
      }
      ...
      {
         var _loc3_:SpecialEffectBullet = new SpecialEffectBullet("PetTiger1Bullet1");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
         _loc3_.setRole(this);
