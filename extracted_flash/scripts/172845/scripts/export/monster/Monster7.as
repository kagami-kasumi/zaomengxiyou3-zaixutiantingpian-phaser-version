package export.monster
{
   ...
   public class Monster7 extends BaseMonster
   {
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster7");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[15],[2,2,2,2,7],[2,2,2,4]]);
         ...
         throw new Error("Monster7--BitmapData Error!");
      }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster7Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 80;
         }
