package export.monster
{
   ...
   public class Monster136 extends BaseMonster
   {
      
      public function Monster136()
      {
         super();
         ...
         this.protectedParamsObject.def = 1323;
         ...
         this.attackBackInfoDict["hit1"] = {
            ...
            "attackKind":"physics",
            "addEffect":[{
               "name":BaseAddEffect.MONSTER136REDUCEMP,
               "time":1
            }]
         };
      ...
      override protected function initBBDC() : void
      {
         ...
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster136");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[8],[2,2,2,2,7],[1,1,1,1]]);
            bbdc.setFrameCount([6,1,5,12]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("Monster136--BitmapData Error!");
      }
      ...
      {
         var _loc2_:FollowBaseObjectBullet = new FollowBaseObjectBullet("Monster136Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 45;
         }
