package export.monster
{
   ...
   public class Monster75 extends BaseMonster
   {
      
      public function Monster75()
      {
         super();
         this.horizenSpeed = 3;
         if(Math.random() <= 0.5)
      ...
      override protected function initBBDC() : void
      {
         ...
         if(_loc2_)
         {
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[15],[2,2,2,2,2],[2,2,10],[2,2,10]]);
