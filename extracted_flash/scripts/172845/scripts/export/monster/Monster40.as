package export.monster
{
   ...
   public class Monster40 extends BaseMonster
   {
      
      public function Monster40()
      {
         ...
         this.horizenSpeed = 4;
         this.setHp(10000 + _loc1_ * 417);
         this.setSHp(10000 + _loc1_ * 417);
         this.attackRange = 250;
         this.alertRange = 1000;
         this.protectedParamsObject.def = 138 + _loc1_ * 3;
         this.protectedParamsObject.mDef = 0.25;
         this.protectedParamsObject.exp = 216;
         this.protectedParamsObject.gxp = 108;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster40");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setOffsetXY(17,-16);
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[15],[2,2,2,2,7],[2,2,2,9]]);
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster40Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 97;
         }
