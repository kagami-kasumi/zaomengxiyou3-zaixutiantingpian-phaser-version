package export.monster
{
   ...
   public class Monster39 extends BaseMonster
   {
      
      public function Monster39()
      {
         ...
         this.horizenSpeed = 4;
         this.setHp(12000 + _loc1_ * 625);
         this.setSHp(12000 + _loc1_ * 625);
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster39");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster39Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 85;
         }
