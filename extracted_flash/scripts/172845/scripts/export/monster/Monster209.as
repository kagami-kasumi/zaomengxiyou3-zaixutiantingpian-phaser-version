package export.monster
{
   ...
   public class Monster209 extends BaseMonster
   {
      ...
      public function Monster209()
      {
         ...
         this.setAction("wait");
         this.protectedParamsObject.fallProbability = 0.3;
      ...
      private function hit3Destroy(bb:BaseBullet) : void
      {
         ...
         if(!this.isDead())
         {
            arr = gc.getPlayerAndPetAndSummonArray();
            for each(bo in arr)
            {
               if(!bo.isYourFather())
               {
