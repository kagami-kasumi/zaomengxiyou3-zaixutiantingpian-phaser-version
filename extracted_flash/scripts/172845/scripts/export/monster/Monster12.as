package export.monster
{
   ...
   public class Monster12 extends BaseMonster
   {
      
      public function Monster12()
      {
         super();
         this.horizenSpeed = 3;
         this.setHp(6000);
         ...
         this.protectedParamsObject.def = 70;
         this.protectedParamsObject.mDef = 0.3;
         this.protectedParamsObject.exp = 96;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster12");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setOffsetXY(-3,-15);
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[15],[2,2,2,2,7],[2,2,2,2,14]]);
         ...
         throw new Error("Monster12--BitmapData Error!");
      }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster12Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 88;
         }
