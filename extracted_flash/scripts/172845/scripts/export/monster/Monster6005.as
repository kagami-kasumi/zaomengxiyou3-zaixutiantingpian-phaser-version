package export.monster
{
   ...
   public class Monster6005 extends MonsterEntity
   {
      
      private static var _this:Monster6005;
      ...
      private var skill4_2times:Number = 0;
      
      public function Monster6005()
      {
         super();
         _this = this;
         ...
         this.skillCD3 = [gc.frameClips * 12,gc.frameClips * 7.1];
         this.skillCD4 = [gc.frameClips * 3,gc.frameClips * 3];
      ...
      public static function getInstance() : Monster6005
      {
         return _this;
      }
      ...
      override protected function initBBDC() : void
      {
         try
         {
            bbdc = AnimationManager.getAnimation("baishuishenjunhunti");
            ...
            case "shanxian_2":
               if(Boolean(this.curAttackTarget) && this.skillCD1[0] == 0)
               {
                  if(!this.isAttacking())
                  {
                     ...
                     TweenMax.delayedCall(0.3,this.banyuezhan1);
                     TweenMax.delayedCall(0.7,this.banyuezhan1_2);
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("baishuishenjun_skill2_2","baishuishenjun_skill2_2_box");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 157;
      ...
      {
         var i:Number = Math.round(Math.random() * 1) + 1;
         var _loc3_:SpecialEffectBullet = new SpecialEffectBullet("baishuishenjun_skill3_2_" + i,"baishuishenjun_skill3_2_" + i + "_box");
         _loc3_.setRole(this);
         if(i == 2)
         {
            if(this.getBBDC().getDirect() == 0)
            {
               _loc3_.x = param1 - _loc3_.width / 3 * 2 - 20;
            }
            else
            {
               _loc3_.x = param1 + _loc3_.width / 3 * 2 + 20;
         ...
         else if(this.getBBDC().getDirect() == 0)
         {
            _loc3_.x = param1 - _loc3_.width * 0.5 - 20;
         }
         else
         {
            _loc3_.x = param1 + _loc3_.width * 0.5 + 20;
      ...
      private function huguangyueshan_2() : void
      {
         ...
         _loc2_.name = "baishuishenjun_skill4_2";
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 157;
      ...
      private function huguangyueshan_3(param1:Number, param2:Number) : void
      {
         ...
         _loc3_.y = param2;
         _loc3_.setDirect(this.getBBDC().getDirect());
         _loc3_.setSpeed(Math.cos(angle) * 15,Math.sin(angle) * 15);
         if(_loc3_.transform.matrix.a > 0)
         {
            _loc3_.setRotaion(-(angle * (-180 / Math.PI) + 180));
         }
         else
         {
            _loc3_.setRotaion(angle * (-180 / Math.PI));
         }
      ...
      override protected function myIntelligence() : void
      {
         ...
         if(gc.gameSence.getChildByName("baishuishenjun_skill4_2"))
         {
            this.skill4_2times += 1;
            if(this.skill4_2times >= 3)
            {
               this.skill4_2times = 0;
               this.huguangyueshan_3(gc.gameSence.getChildByName("baishuishenjun_skill4_2").x,gc.gameSence.getChildByName("baishuishenjun_skill4_2").y + 179);
               this.huguangyueshan_3(gc.gameSence.getChildByName("baishuishenjun_skill4_2").x,gc.gameSence.getChildByName("baishuishenjun_skill4_2").y + 179);
               this.huguangyueshan_3(gc.gameSence.getChildByName("baishuishenjun_skill4_2").x,gc.gameSence.getChildByName("baishuishenjun_skill4_2").y + 179);
            }
         }
