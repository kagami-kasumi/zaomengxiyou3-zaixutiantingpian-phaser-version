package export.monster
{
   ...
   public class Monster71 extends BaseMonster
   {
      
      private var skill1Release:Boolean = false;
      
      public function Monster71()
      {
         super();
         this.horizenSpeed = 3;
         if(gc.hero1)
         ...
         this.attackBackInfoDict["hit2"] = {
            ...
            "attackInterval":24,
            "power":10 + (this.getLevel() - 1) * 5,
            "addEffect":[{"time":gc.frameClips * 2}]
         };
         ...
         this.skillCD2 = [gc.frameClips * 4,gc.frameClips * 10];
         this.isBoss = false;
      }
      ...
      override protected function initBBDC() : void
      {
         ...
         if(_loc2_)
         {
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[15],[2,2,2,2,10],[2,4,20],[15],[2,2,1,1,8]]);
