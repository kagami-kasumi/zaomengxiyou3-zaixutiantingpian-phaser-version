package export.monster
{
   ...
   public class Monster32 extends BaseMonster
   {
      
      internal var isNotArrow:Boolean = false;
      
      internal var role4Hit5:MonsterRole4Hit5;
      
      internal var gxpCount:uint;
      
      public function Monster32()
      {
         super();
      ...
      override public function destroy() : void
      {
         ...
         {
            MainGame.getInstance().createMonster(33,800,300);
         }
      }
      ...
      {
         var _loc1_:* = null;
         var _loc2_:* = BaseBitmapDataPool.getBitmapDataArrayByName("Monster32");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
         ...
         throw new Error("Monster32--BitmapData Error!");
      }
               ...
               else
               {
                  ...
                  if(this.bbdc.getCurFrameCount() == 17 || this.bbdc.getCurFrameCount() == 12 || this.bbdc.getCurFrameCount() == 6)
                  {
                     if(param1.x == 1 || param1.x == 5)
                     {
                        ...
                        _loc9_.y = this.y - (-7 + this.bbdc.getCurFrameCount() * 2);
      ...
      internal function reHit6(param1:SpecialEffectBullet, param2:BaseObject, param3:uint, param4:Number) : void
      {
         ...
         if(_times > 0)
         {
            ...
            TweenMax.to(_b,_moveTime,{
               "x":_target.x,
               "y":_target.y,
               "onComplete":function(param1:Monster32, param2:SpecialEffectBullet, param3:BaseObject, param4:uint):*
               {
