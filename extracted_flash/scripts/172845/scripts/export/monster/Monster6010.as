package export.monster
{
   ...
   public class Monster6010 extends MonsterEntity
   {
      
      private static var _this:Monster6010;
      ...
      public static function getInstance() : Monster6010
      {
         return _this;
      }
      ...
      override protected function initBBDC() : void
      {
         try
         {
            bbdc = AnimationManager.getAnimation("tiantingzhanshen");
         ...
         switch(action)
         {
            case "skill1":
               ...
               if(frameCount == 37)
               {
                  this.faceToTarget();
                  this.speed.y = -37.6;
                  this.speed.x = Boolean(this.curAttackTarget) ? (this.curAttackTarget.x - this.x) / 11 : 0;
               }
               if(frameCount == 44)
               {
                  this.graity = 0;
            ...
            case "skill2_2":
               if(frameCount == 1)
               {
                  ...
                  this.manyuezhan_1();
                  this.manyuezhan_2();
                  MainGame.getInstance().createMonster(6011,this.x,this.y);
               }
               if(this.getBBDC().getDirect() == 0)
               {
                  this.speed.x = -70;
            ...
            case "skill3_2":
               if(frameCount == 1)
               {
                  this.yuesemenglong_2();
                  this.yuesemenglong_15();
               }
               if(frameCount == 2)
               {
                  this.yuesemenglong_3();
                  this.yuesemenglong_14();
               }
               if(frameCount == 5)
               {
                  this.yuesemenglong_6();
                  this.yuesemenglong_11();
               }
               if(frameCount == 6)
               {
                  this.yuesemenglong_7();
                  this.yuesemenglong_10();
               }
               if(frameCount == 7)
               {
                  this.yuesemenglong_8();
                  this.yuesemenglong_9();
               }
               break;
            case "skill4_1":
               if(frameCount == 1)
      ...
      {
         var _loc2_:FollowBaseObjectBullet = new FollowBaseObjectBullet("ttzs_skill1");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
      ...
      {
         var _loc2_:FollowBaseObjectBullet = new FollowBaseObjectBullet("ttzs_skill1_1");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 156 - 90;
      ...
      {
         if(this.curAction == "skill1" || this.curAction == "skill2_1" || this.curAction == "skill2_2" || this.curAction == "skill2_3" || this.curAction == "skill3_1" || this.curAction == "skill3_2" || this.curAction == "skill4_3" || this.curAction == "skill4_2" || this.curAction == "skill4_1" || this.curAction == "shanxian" || this.curAction == "shanxian_2")
         {
            param2 = false;
         }
