package export.monster
{
   ...
   public class Monster11 extends BaseMonster
   {
      
      public function Monster11()
      {
         super();
         this.horizenSpeed = 3;
         this.setHp(8000);
         ...
         this.protectedParamsObject.exp = 88;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster11");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[15],[2,2,2,2,7],[2,2,2,20]]);
         ...
         throw new Error("Monster11--BitmapData Error!");
      }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster11Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 87;
         }
