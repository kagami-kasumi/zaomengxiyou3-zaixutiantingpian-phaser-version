package export.monster
{
   ...
   public class Monster6009 extends MonsterEntity
   {
      
      private static var _this:Monster6009;
      ...
      private var firebolltime:int = 390;
      
      public function Monster6009()
      {
         super();
         _this = this;
         this.setHp(9800000 * 0.7 * 0.65);
         this.setSHp(9800000 * 0.7 * 0.65);
         ...
         this.skillCD2 = [gc.frameClips * 5.2,gc.frameClips * 15];
      ...
      public static function getInstance() : Monster6009
      {
         return _this;
      }
      ...
      override protected function initBBDC() : void
      {
         try
         {
            bbdc = AnimationManager.getAnimation("qingyangshenjunhunti");
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("qingyangshenjun_skill1_4","qingyangshenjun_skill1_4_box");
         _loc2_.setRole(this);
         if(this.getBBDC().getDirect() == 0)
         {
            _loc2_.x = this.x - 151;
