   ...
   public class Monster9 extends BaseMonster
   {
      ...
      public function Monster9()
      {
         ...
         if(gc.curStage == 9)
         {
            ...
            this.protectedParamsObject.exp = 60;
            this.protectedParamsObject.gxp = 32;
            this.setHp(103737);
            this.setSHp(103737);
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster9");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
         ...
         throw new Error("Monster9--BitmapData Error!");
      }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster9Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 85;
         }
