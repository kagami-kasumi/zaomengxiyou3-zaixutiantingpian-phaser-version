package export.monster
{
   ...
   public class Monster24 extends BaseMonster
   {
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster24");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setOffsetXY(15,-25);
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[15],[2,2,2,2,10],[2,2,10],[2,30],[1,1,1,1]]);
            bbdc.setFrameCount([6,4,1,5,3,2,20]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("Monster24--BitmapData Error!");
      }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster24Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 180;
         }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster24Bullet2");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 250;
         }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster24Bullet3");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 100;
         }
