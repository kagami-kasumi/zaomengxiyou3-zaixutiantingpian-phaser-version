package export.monster
{
   ...
   public class Monster116 extends BaseMonster
   {
      
      public function Monster116()
      {
         super();
         this.horizenSpeed = 4;
         this.setHp(450000);
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster116");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setOffsetXY(9,13);
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[8],[2,2,2,2,10],[2,2,2,10],[2,2,2,10]]);
         ...
         throw new Error("Monster116--BitmapData Error!");
      }
      ...
      {
         var _loc2_:SpecialEffectBullet = new SpecialEffectBullet("Monster116Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 35;
         }
      ...
      private function doHi2(param1:uint) : void
      {
         ...
         {
            _loc2_ = new SpecialEffectBullet("Monster116Bullet2");
