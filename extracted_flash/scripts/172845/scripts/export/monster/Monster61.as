package export.monster
{
   ...
   public class Monster61 extends BaseMonster
   {
      
      public function Monster61()
      {
         super();
         this.horizenSpeed = 4;
         this.setHp(160000);
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("Monster61");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setOffsetXY(-5,-6);
            bbdc.setFrameStopCount([[3,3,3,4,3,4],[15],[2,2,2,2,9],[2,2,2,19],[2,2,2,9]]);
         ...
         throw new Error("Monster61--BitmapData Error!");
      }
      ...
      {
         var _loc2_:EnemyMoveBullet = new EnemyMoveBullet("Monster61Bullet1");
         if(param1 == 0)
         {
            _loc2_.x = this.x - 82;
         }
