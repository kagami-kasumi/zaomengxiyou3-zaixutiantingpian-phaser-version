package export.bullet
{
   ...
   import export.monster.Monster6008;
   import export.monster.Monster6009;
   import flash.geom.Point;
   
   public class EnemyMoveBullet3 extends BaseBullet
   {
      ...
      public function EnemyMoveBullet3(param1:String, param2:String = "")
      {
         super(param1,param2);
      }
      ...
      {
         if(this.sourceRole is Monster6008 || this.sourceRole is Monster6009)
         {
            this.sourceRole.yuesemenglong_2(this.x,this.y,this.getDirect());
         }
         super.destroy();
      }
   }
