package export.bullet
{
   ...
   public class FastAndSlowBullet extends BaseBullet
   {
      ...
      private var beginslowdistance:Number = 9999;
      
      private var slowspeed:Point = null;
      
      public function FastAndSlowBullet(param1:String, param2:String = "")
      {
         super(param1,param2);
         this.slowspeed = new Point();
      }
      ...
      override protected function step() : void
      {
         ...
         this.beginslowdistance -= Math.sqrt(this.speed.x * this.speed.x + this.speed.y * this.speed.y);
         if(this.beginslowdistance <= 0)
         {
            this.speed.x = this.slowspeed.x;
            this.speed.y = this.slowspeed.y;
         }
         if(this.distance <= 0)
         {
      ...
      public function setBeginSlowDistance(param1:int) : void
      {
         this.beginslowdistance = param1;
      }
      ...
      public function setSlowSpeed(param1:Number, param2:Number = 0) : void
      {
         this.slowspeed.x = param1;
         this.slowspeed.y = param2;
      }
