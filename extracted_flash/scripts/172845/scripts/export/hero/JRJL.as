package export.hero
{
   ...
   public class JRJL extends Sprite
   {
      ...
      private var _arrowTotal:int = 3;
      
      public function JRJL(param1:Class, param2:*)
      {
      ...
      private function start() : void
      {
         ...
         this._nowTimes[0].n = 0;
         this.Empty = false;
      }
      
      public function step(param1:int = 0) : void
      {
         this.addMcTime(11.1 * 0.5);
         this.updateMcFrame();
         this.follow();
      }
      ...
      public function toShoot() : void
      {
         ...
         if(Boolean(_loc2_) && _loc2_.currentFrame == _loc2_.totalFrames)
         {
            this._nowTimes[0].n = this._nowTimes[1].n;
            this._nowTimes[1].n = this._nowTimes[2].n;
            if(this._mcs[2].currentFrame == this._mcs[2].totalFrames)
            {
               this._nowTimes[2].n = 0;
            }
            else if(this._mcs[1].currentFrame == this._mcs[1].totalFrames)
            {
               this._nowTimes[1].n = 0;
            }
            else
            {
               this._nowTimes[0].n = 0;
