package export.pet
{
   ...
   public class PetKabu1 extends BasePet
   {
      
      public function PetKabu1(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetKabuBmd1");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[8],[2,2,2,2,2],[2,2,2,10],[2,2,2,10]]);
         ...
         throw new Error("PetKabuBmd1--BitmapData Error!");
      }
