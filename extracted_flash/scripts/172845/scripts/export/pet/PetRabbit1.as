package export.pet
{
   ...
   public class PetRabbit1 extends BasePet
   {
      
      public function PetRabbit1(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      override protected function releSkill1() : void
      {
         ...
         this._petInfo.setMp(Number(this._petInfo.getMp()) - Number(this._petInfo.findPetUsedMagic("yg")));
      }
