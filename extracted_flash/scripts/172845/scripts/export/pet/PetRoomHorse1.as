package export.pet
{
   ...
   public class PetRoomHorse1 extends BasePet
   {
      
      public function PetRoomHorse1(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetRoomHorseBmd1");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setOffsetXY(1,-33);
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[8],[2,2,2,2,2,10],[3,3,10],[2,2,2,2]]);
            bbdc.setFrameCount([6,4,1,6,3,20]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("PetRoomHorseBmd1--BitmapData Error!");
      }
