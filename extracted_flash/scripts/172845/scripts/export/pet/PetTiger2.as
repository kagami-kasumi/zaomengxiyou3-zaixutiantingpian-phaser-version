package export.pet
{
   ...
   public class PetTiger2 extends BasePet
   {
      
      public function PetTiger2(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
         ...
         this.attackRange = 40;
         this.setAction("wait");
         this.skillCD1 = [gc.frameClips * 4,gc.frameClips * 3];
         this.skillCD2 = [gc.frameClips * 5,gc.frameClips * 3];
      }
      
      override protected function initBBDC() : void
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetTigerBmd2");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[8],[2,2,2,2,10],[2,2,2,10],[2,2,10],[2,2,10]]);
         ...
         throw new Error("PetTigerBmd2--BitmapData Error!");
      }
