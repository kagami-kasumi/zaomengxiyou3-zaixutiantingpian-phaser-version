package export.pet
{
   ...
   public class PetHorse2 extends BasePet
   {
      
      private var skill1Release:Boolean = false;
      
      public function PetHorse2(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
         this.attackRange = 70;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetHorseBmd2");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setOffsetXY(1,-3);
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[8],[2,2,2,2,10],[2,4,20],[15],[2,2,1,1,8]]);
            bbdc.setFrameCount([6,4,1,4,3,1,5]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("PetHorseBmd2--BitmapData Error!");
      }
      ...
      {
         var _loc3_:SpecialEffectBullet = new SpecialEffectBullet("PetHorse2Bullet1");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
         _loc3_.setRole(this);
      ...
      private function doHit2(param1:uint, param2:Point) : void
      {
         ...
         var _loc3_:FollowBaseObjectBullet = new FollowBaseObjectBullet("PetHorse2Bullet2");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
         _loc3_.setRole(this);
         _loc3_.setDirect(param1);
      ...
      {
         var _loc3_:SpecialEffectBullet = new SpecialEffectBullet("PetHorse1Bullet2");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
         _loc3_.setRole(this);
         _loc3_.setDirect(param1);
