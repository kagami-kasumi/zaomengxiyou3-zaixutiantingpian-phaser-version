package export.pet
{
   ...
   public class PetDragon2 extends BasePet
   {
      ...
      public function PetDragon2(param1:BaseHero, param2:PetInfo)
      {
         this.fenshenArray = [];
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetDragonBmd2");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[8],[2,2,2,2,10],[2,2,2,10],[2,2,2,2,10],[30]]);
            bbdc.setFrameCount([6,4,1,5,4,5,1]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("PetDragonBmd2--BitmapData Error!");
      }
      ...
      {
         var _loc3_:SpecialEffectBullet = new SpecialEffectBullet("PetDragon2Bullet1");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
         _loc3_.setRole(this);
      ...
      private function doHit2(param1:uint, param2:Point) : void
      {
         ...
         _loc3_ = new PetDragon2(this.sourceRole,_loc4_);
