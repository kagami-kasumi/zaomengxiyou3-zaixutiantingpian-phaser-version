package export.pet
{
   ...
   public class PetHorse3 extends BasePet
   {
      
      private var skill1Release:Boolean = false;
      
      public function PetHorse3(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetHorseBmd3");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[8],[2,2,2,2,10],[2,2,20],[15],[2,2,1,1,10],[2,2,20]]);
            bbdc.setFrameCount([6,4,1,4,3,1,5,3]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("PetHorseBmd3--BitmapData Error!");
      }
