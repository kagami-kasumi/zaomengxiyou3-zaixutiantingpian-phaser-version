package export.pet
{
   ...
   public class PetMonkey1 extends BasePet
   {
      
      private var skill1Release:Boolean = false;
      
      public function PetMonkey1(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      override protected function initBBDC() : void
      {
         ...
         if(_loc2_)
         {
            ...
            bbdc.setFrameStopCount([[2,2,2,2],[8],[2,2,2,2,1,1],[2,2,2,10],[1,1,1,12]]);
      ...
      {
         return Boolean(this.skill1Release) && this._petInfo.getMp() >= this._petInfo.findPetUsedMagic("xj") && Boolean(this._petInfo.findHasStudySkill("xj"));
      }
