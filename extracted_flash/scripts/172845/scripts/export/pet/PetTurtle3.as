package export.pet
{
   ...
   public class PetTurtle3 extends BasePet
   {
      
      public function PetTurtle3(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetTurtleBmd3");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
         ...
         throw new Error("PetTurtleBmd3--BitmapData Error!");
      }
