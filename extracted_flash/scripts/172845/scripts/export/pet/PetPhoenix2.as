package export.pet
{
   ...
   public class PetPhoenix2 extends BasePet
   {
      
      public function PetPhoenix2(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetPhoenixBmd2");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[8,2 * 60],[2,2,2,2,10],[2,2,2,10],[2,2,2,24]]);
            bbdc.setFrameCount([6,4,[1,1],5,4,3]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("PetPhoenixBmd2--BitmapData Error!");
      }
      ...
      override protected function releSkill2() : void
      {
         ...
         this._petInfo.setMp(Number(this._petInfo.getMp()) - Number(this._petInfo.findPetUsedMagic("bshn")));
      }
