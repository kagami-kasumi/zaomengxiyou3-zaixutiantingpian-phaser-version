package export.pet
{
   ...
   public class PetTiger4 extends BasePet
   {
      ...
      public function PetTiger4(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
         ...
         this.skillCD2 = [gc.frameClips * 8,gc.frameClips * 4.6];
         this.skillCD3 = [gc.frameClips * 6,gc.frameClips * 6];
      ...
      {
         return this.curAttackTarget != null && this._petInfo.getMp() >= this._petInfo.findPetUsedMagic("bhaoyi") && Boolean(this._petInfo.findHasStudySkill("bhaoyi"));
      }
      ...
      override protected function releSkill4() : void
      {
         ...
         this._petInfo.setMp(Number(this._petInfo.getMp()) - Number(this._petInfo.findPetUsedMagic("bhaoyi")));
      }
      ...
      private function doHit3_2_1(param1:uint, param2:Point) : void
      {
         var _loc3_:SpecialEffectBullet = new SpecialEffectBullet("PetTiger2Bullet3_2");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
      ...
      private function doBeforeHit5_3() : void
      {
         if(gc.sid == this.sourceRole.sid)
         {
            gc.sendPetAttack(this.sourceRole.getRoleId(),"hit6Action",this.getBBDC().getDirect(),0,0,[]);
         }
         ...
         switch(param1)
         {
            case "hit1":
               if(this.isAtkUp)
               {
                  this.isAtkUp = false;
                  return {
                     "hurt":(this._petInfo.getAtk() + _loc5_) * _loc4_ * _loc6_ * Number(this.hurtBaseEffectRate()) * 1.3,
                     "qixue":0
                  };
               }
               return {
            ...
            case "hit4":
               ...
               if(_loc3_)
               {
                  if(this.isAtkUp)
                  {
                     this.isAtkUp = false;
                     return {
                        "hurt":(_loc3_.first + _loc5_) * _loc4_ * _loc6_ * Number(this.hurtBaseEffectRate()) * 1.3,
                        "qixue":0
                     };
                  }
                  return {
      ...
      {
         return this.curAction == "hit1" || this.curAction == "hit2" || this.curAction == "hit3" || this.curAction == "hit3_1" || this.curAction == "hit4" || this.curAction == "hit5" || this.curAction == "hit6";
      }
