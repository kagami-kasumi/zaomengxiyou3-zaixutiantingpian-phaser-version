package export.pet
{
   ...
   public class PetRabbit3 extends BasePet
   {
      
      public function PetRabbit3(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      override protected function initBBDC() : void
      {
         ...
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetPetRabbitBmd3");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
         ...
         throw new Error("PetPetRabbitBmd3--BitmapData Error!");
      }
