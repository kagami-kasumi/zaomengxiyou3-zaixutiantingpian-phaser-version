package export.pet
{
   ...
   public class PetTurtle2 extends BasePet
   {
      
      public function PetTurtle2(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetTurtleBmd2");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[4,4,4,4],[8],[2,2,2,2,2],[2,2,2,10],[2,2,10]]);
         ...
         throw new Error("PetTurtleBmd2--BitmapData Error!");
      }
         ...
         if(this.curAddEffect)
         {
            ...
            if(_loc4_)
            {
               if(Boolean(this.sourceRole) && Boolean(this.sourceRole.curAddEffect))
               {
                  ...
                  if(_loc5_)
                  {
                     this.sourceRole.roleProperies.setHHP(this.sourceRole.roleProperies.getHHP() + _loc6_);
