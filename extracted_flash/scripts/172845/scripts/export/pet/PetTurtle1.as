package export.pet
{
   ...
   public class PetTurtle1 extends BasePet
   {
      
      public function PetTurtle1(param1:BaseHero, param2:PetInfo)
      {
         super(param1,param2);
         this.horizenSpeed = 5;
      ...
      {
         var _loc1_:* = null;
         var _loc2_:Array = BaseBitmapDataPool.getBitmapDataArrayByName("PetTurtleBmd1");
         if(_loc2_)
         {
            _loc1_ = {
               "name":"body",
            ...
            bbdc.setFrameStopCount([[2,2,2,3,2,4],[8],[2,2,2,2,2],[2,2,10],[2,2,10]]);
            bbdc.setFrameCount([6,1,5,3,3]);
            bbdc.setEnterFrameCallBack(this.enterFrameFunc,this.exitFrameFunc);
            bbdc.setAddScriptWhenFrameOver(this.scriptFrameOverFunc);
            this.body.addChild(bbdc);
            return;
         }
         throw new Error("PetTurtleBmd1--BitmapData Error!");
      }
      ...
      {
         var _loc3_:SpecialEffectBullet = new SpecialEffectBullet("PetTurtle1Bullet1");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
         _loc3_.setRole(this);
      ...
      {
         var _loc3_:FollowBaseObjectBullet = new FollowBaseObjectBullet("PetTurtle1Bullet2");
         _loc3_.x = param2.x;
         _loc3_.y = param2.y;
         _loc3_.setRole(this);
         ...
         gc.gameSence.addChild(_loc3_);
         this.magicBulletArray.push(_loc3_);
         var _loc4_:uint = uint(this.getRealPower("hit2",false).hurt);
         this.cureHp(_loc4_);
      }
